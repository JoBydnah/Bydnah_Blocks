...
public class Steeldoor2Block extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:steeldoor_2")
	public static final Block block = null;

	public Steeldoor2Block(BydnahBlocksModElements instance) {
		super(instance, 316);
	}
