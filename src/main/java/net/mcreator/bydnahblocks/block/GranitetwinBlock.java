...
public class GranitetwinBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitetwin")
	public static final Block block = null;

	public GranitetwinBlock(BydnahBlocksModElements instance) {
		super(instance, 474);
	}
