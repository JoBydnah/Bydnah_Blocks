...
public class JaspertileslargeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jaspertileslarge")
	public static final Block block = null;

	public JaspertileslargeBlock(BydnahBlocksModElements instance) {
		super(instance, 621);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jaspertileslarge");
		}
