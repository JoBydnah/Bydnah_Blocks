...
public class ReinforcedlimeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedlime")
	public static final Block block = null;

	public ReinforcedlimeBlock(BydnahBlocksModElements instance) {
		super(instance, 265);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedlime");
		}
