...
public class UraniumcrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:uraniumcrate")
	public static final Block block = null;

	public UraniumcrateBlock(BydnahBlocksModElements instance) {
		super(instance, 121);
	}
