...
public class AridsandstonetilessmallBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonetilessmall")
	public static final Block block = null;

	public AridsandstonetilessmallBlock(BydnahBlocksModElements instance) {
		super(instance, 566);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonetilessmall");
		}
