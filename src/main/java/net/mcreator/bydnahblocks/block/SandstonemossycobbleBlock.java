...
public class SandstonemossycobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonemossycobble")
	public static final Block block = null;

	public SandstonemossycobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 497);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonemossycobble");
		}
