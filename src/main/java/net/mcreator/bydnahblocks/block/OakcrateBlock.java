...
public class OakcrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:oakcrate")
	public static final Block block = null;

	public OakcrateBlock(BydnahBlocksModElements instance) {
		super(instance, 273);
	}
