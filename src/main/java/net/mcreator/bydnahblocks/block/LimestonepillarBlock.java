...
public class LimestonepillarBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:limestonepillar")
	public static final Block block = null;

	public LimestonepillarBlock(BydnahBlocksModElements instance) {
		super(instance, 798);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("limestonepillar");
		}
