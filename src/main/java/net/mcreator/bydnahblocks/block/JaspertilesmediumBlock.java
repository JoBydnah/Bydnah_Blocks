...
public class JaspertilesmediumBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jaspertilesmedium")
	public static final Block block = null;

	public JaspertilesmediumBlock(BydnahBlocksModElements instance) {
		super(instance, 622);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jaspertilesmedium");
		}
