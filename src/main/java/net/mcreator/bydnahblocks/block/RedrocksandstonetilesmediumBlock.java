...
public class RedrocksandstonetilesmediumBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonetilesmedium")
	public static final Block block = null;

	public RedrocksandstonetilesmediumBlock(BydnahBlocksModElements instance) {
		super(instance, 650);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonetilesmedium");
		}
