...
public class DarkoakcrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:darkoakcrate")
	public static final Block block = null;

	public DarkoakcrateBlock(BydnahBlocksModElements instance) {
		super(instance, 248);
	}
