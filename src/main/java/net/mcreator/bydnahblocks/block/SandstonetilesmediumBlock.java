...
public class SandstonetilesmediumBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonetilesmedium")
	public static final Block block = null;

	public SandstonetilesmediumBlock(BydnahBlocksModElements instance) {
		super(instance, 507);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonetilesmedium");
		}
