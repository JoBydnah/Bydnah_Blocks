...
public class GranitetileslargeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitetileslarge")
	public static final Block block = null;

	public GranitetileslargeBlock(BydnahBlocksModElements instance) {
		super(instance, 388);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitetileslarge");
		}
