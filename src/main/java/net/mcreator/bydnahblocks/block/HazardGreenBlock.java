...
public class HazardGreenBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:hazard_green")
	public static final Block block = null;

	public HazardGreenBlock(BydnahBlocksModElements instance) {
		super(instance, 42);
	}
