...
public class JadestoneSlabBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_slab")
	public static final Block block = null;

	public JadestoneSlabBlock(BydnahBlocksModElements instance) {
		super(instance, 144);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("jadestone_slab");
		}
