...
public class MarblechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblechiseled")
	public static final Block block = null;

	public MarblechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 311);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marblechiseled");
		}
