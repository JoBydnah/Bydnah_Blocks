...
public class BirchthickbeamsBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:birchthickbeams")
	public static final Block block = null;

	public BirchthickbeamsBlock(BydnahBlocksModElements instance) {
		super(instance, 228);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("birchthickbeams");
		}
