...
public class CopperencasedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:copperencased")
	public static final Block block = null;

	public CopperencasedBlock(BydnahBlocksModElements instance) {
		super(instance, 92);
	}
