...
public class AridsandstonetwinchiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonetwinchiseled")
	public static final Block block = null;

	public AridsandstonetwinchiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 567);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonetwinchiseled");
		}
