...
public class SandstonepatternBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonepattern")
	public static final Block block = null;

	public SandstonepatternBlock(BydnahBlocksModElements instance) {
		super(instance, 503);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonepattern");
		}
