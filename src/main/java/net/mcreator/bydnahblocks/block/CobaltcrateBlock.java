...
public class CobaltcrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:cobaltcrate")
	public static final Block block = null;

	public CobaltcrateBlock(BydnahBlocksModElements instance) {
		super(instance, 183);
	}
