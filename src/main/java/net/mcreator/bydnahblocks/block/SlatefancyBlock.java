...
public class SlatefancyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatefancy")
	public static final Block block = null;

	public SlatefancyBlock(BydnahBlocksModElements instance) {
		super(instance, 582);
	}
