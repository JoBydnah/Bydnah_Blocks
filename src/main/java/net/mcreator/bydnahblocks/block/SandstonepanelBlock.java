...
public class SandstonepanelBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonepanel")
	public static final Block block = null;

	public SandstonepanelBlock(BydnahBlocksModElements instance) {
		super(instance, 502);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonepanel");
		}
