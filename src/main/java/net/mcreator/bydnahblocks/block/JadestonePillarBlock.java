...
public class JadestonePillarBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_pillar")
	public static final Block block = null;

	public JadestonePillarBlock(BydnahBlocksModElements instance) {
		super(instance, 759);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("jadestone_pillar");
		}
