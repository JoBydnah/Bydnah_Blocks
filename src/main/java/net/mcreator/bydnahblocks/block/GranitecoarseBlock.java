...
public class GranitecoarseBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitecoarse")
	public static final Block block = null;

	public GranitecoarseBlock(BydnahBlocksModElements instance) {
		super(instance, 434);
	}
