...
public class MarbletwinchiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marbletwinchiseled")
	public static final Block block = null;

	public MarbletwinchiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 409);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletwinchiseled");
		}
