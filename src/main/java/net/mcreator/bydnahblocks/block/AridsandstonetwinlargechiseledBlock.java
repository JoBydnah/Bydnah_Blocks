...
public class AridsandstonetwinlargechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonetwinlargechiseled")
	public static final Block block = null;

	public AridsandstonetwinlargechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 568);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonetwinlargechiseled");
		}
