...
public class SteelscaffoldBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:steelscaffold")
	public static final Block block = null;

	public SteelscaffoldBlock(BydnahBlocksModElements instance) {
		super(instance, 192);
	}
