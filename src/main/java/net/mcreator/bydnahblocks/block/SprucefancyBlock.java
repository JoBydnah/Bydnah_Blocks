...
public class SprucefancyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sprucefancy")
	public static final Block block = null;

	public SprucefancyBlock(BydnahBlocksModElements instance) {
		super(instance, 288);
	}
