...
public class SlatepatternBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatepattern")
	public static final Block block = null;

	public SlatepatternBlock(BydnahBlocksModElements instance) {
		super(instance, 589);
	}
