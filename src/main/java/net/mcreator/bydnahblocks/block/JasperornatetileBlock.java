...
public class JasperornatetileBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jasperornatetile")
	public static final Block block = null;

	public JasperornatetileBlock(BydnahBlocksModElements instance) {
		super(instance, 613);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jasperornatetile");
		}
