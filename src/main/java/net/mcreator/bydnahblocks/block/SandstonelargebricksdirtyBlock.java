...
public class SandstonelargebricksdirtyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonelargebricksdirty")
	public static final Block block = null;

	public SandstonelargebricksdirtyBlock(BydnahBlocksModElements instance) {
		super(instance, 496);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonelargebricksdirty");
		}
