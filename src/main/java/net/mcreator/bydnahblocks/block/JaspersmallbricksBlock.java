...
public class JaspersmallbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jaspersmallbricks")
	public static final Block block = null;

	public JaspersmallbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 619);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jaspersmallbricks");
		}
