...
public class ReinforcedplatingyellowBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatingyellow")
	public static final Block block = null;

	public ReinforcedplatingyellowBlock(BydnahBlocksModElements instance) {
		super(instance, 288);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatingyellow");
		}
