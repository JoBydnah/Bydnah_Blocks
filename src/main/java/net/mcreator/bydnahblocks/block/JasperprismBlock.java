...
public class JasperprismBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jasperprism")
	public static final Block block = null;

	public JasperprismBlock(BydnahBlocksModElements instance) {
		super(instance, 617);
	}
