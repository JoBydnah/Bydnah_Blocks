...
public class DarkoakwideplanksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:darkoakwideplanks")
	public static final Block block = null;

	public DarkoakwideplanksBlock(BydnahBlocksModElements instance) {
		super(instance, 257);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("darkoakwideplanks");
		}
