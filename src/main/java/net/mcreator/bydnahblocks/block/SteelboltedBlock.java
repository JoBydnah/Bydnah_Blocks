...
public class SteelboltedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:steelbolted")
	public static final Block block = null;

	public SteelboltedBlock(BydnahBlocksModElements instance) {
		super(instance, 107);
	}
