...
public class IroncasingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:ironcasing")
	public static final Block block = null;

	public IroncasingBlock(BydnahBlocksModElements instance) {
		super(instance, 88);
	}
