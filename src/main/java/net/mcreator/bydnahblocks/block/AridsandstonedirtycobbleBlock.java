...
public class AridsandstonedirtycobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonedirtycobble")
	public static final Block block = null;

	public AridsandstonedirtycobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 547);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonedirtycobble");
		}
