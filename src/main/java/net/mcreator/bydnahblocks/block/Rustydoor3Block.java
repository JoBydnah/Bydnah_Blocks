...
public class Rustydoor3Block extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:rustydoor_3")
	public static final Block block = null;

	public Rustydoor3Block(BydnahBlocksModElements instance) {
		super(instance, 383);
	}
