...
public class AndesitelargebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitelargebricks")
	public static final Block block = null;

	public AndesitelargebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 421);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitelargebricks");
		}
