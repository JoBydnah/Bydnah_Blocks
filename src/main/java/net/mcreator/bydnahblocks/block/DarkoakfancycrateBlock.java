...
public class DarkoakfancycrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:darkoakfancycrate")
	public static final Block block = null;

	public DarkoakfancycrateBlock(BydnahBlocksModElements instance) {
		super(instance, 251);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("darkoakfancycrate");
		}
