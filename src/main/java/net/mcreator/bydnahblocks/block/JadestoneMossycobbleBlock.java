...
public class JadestoneMossycobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_mossycobble")
	public static final Block block = null;

	public JadestoneMossycobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jadestone_mossycobble");
		}
