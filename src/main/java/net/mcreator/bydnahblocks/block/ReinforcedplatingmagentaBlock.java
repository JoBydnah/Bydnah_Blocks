...
public class ReinforcedplatingmagentaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatingmagenta")
	public static final Block block = null;

	public ReinforcedplatingmagentaBlock(BydnahBlocksModElements instance) {
		super(instance, 282);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatingmagenta");
		}
