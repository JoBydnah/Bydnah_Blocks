...
public class SprucecleanBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:spruceclean")
	public static final Block block = null;

	public SprucecleanBlock(BydnahBlocksModElements instance) {
		super(instance, 366);
	}
