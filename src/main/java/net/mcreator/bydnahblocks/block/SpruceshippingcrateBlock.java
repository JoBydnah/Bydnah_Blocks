...
public class SpruceshippingcrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:spruceshippingcrate")
	public static final Block block = null;

	public SpruceshippingcrateBlock(BydnahBlocksModElements instance) {
		super(instance, 373);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("spruceshippingcrate");
		}
