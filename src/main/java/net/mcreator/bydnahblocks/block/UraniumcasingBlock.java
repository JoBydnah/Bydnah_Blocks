...
public class UraniumcasingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:uraniumcasing")
	public static final Block block = null;

	public UraniumcasingBlock(BydnahBlocksModElements instance) {
		super(instance, 201);
	}
