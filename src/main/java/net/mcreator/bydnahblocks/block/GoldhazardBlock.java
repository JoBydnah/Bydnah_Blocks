...
public class GoldhazardBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:goldhazard")
	public static final Block block = null;

	public GoldhazardBlock(BydnahBlocksModElements instance) {
		super(instance, 99);
	}
