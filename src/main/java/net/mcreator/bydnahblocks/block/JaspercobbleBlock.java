...
public class JaspercobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jaspercobble")
	public static final Block block = null;

	public JaspercobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 607);
	}
