...
public class RustyFrameBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:rusty_frame")
	public static final Block block = null;

	public RustyFrameBlock(BydnahBlocksModElements instance) {
		super(instance, 74);
	}
