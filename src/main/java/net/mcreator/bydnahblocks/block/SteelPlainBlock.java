...
public class SteelPlainBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:steel_plain")
	public static final Block block = null;

	public SteelPlainBlock(BydnahBlocksModElements instance) {
		super(instance, 299);
	}
