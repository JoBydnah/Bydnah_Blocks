...
public class MarblecarvingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblecarving")
	public static final Block block = null;

	public MarblecarvingBlock(BydnahBlocksModElements instance) {
		super(instance, 315);
	}
