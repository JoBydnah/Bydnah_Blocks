...
public class ReinforcedrustyplateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedrustyplate")
	public static final Block block = null;

	public ReinforcedrustyplateBlock(BydnahBlocksModElements instance) {
		super(instance, 162);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedrustyplate");
		}
