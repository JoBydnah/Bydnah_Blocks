...
public class RedrocksandstonemossycobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonemossycobble")
	public static final Block block = null;

	public RedrocksandstonemossycobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 638);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonemossycobble");
		}
