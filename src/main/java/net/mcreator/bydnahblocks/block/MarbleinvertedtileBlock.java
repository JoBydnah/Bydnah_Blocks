...
public class MarbleinvertedtileBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marbleinvertedtile")
	public static final Block block = null;

	public MarbleinvertedtileBlock(BydnahBlocksModElements instance) {
		super(instance, 413);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbleinvertedtile");
		}
