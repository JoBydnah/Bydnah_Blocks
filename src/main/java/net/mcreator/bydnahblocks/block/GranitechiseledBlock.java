...
public class GranitechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitechiseled")
	public static final Block block = null;

	public GranitechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 447);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitechiseled");
		}
