...
public class MarblesmoothBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblesmooth")
	public static final Block block = null;

	public MarblesmoothBlock(BydnahBlocksModElements instance) {
		super(instance, 395);
	}
