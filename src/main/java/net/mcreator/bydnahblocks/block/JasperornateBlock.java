...
public class JasperornateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jasperornate")
	public static final Block block = null;

	public JasperornateBlock(BydnahBlocksModElements instance) {
		super(instance, 612);
	}
