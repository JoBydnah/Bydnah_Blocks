...
public class AridsandstonepavementBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonepavement")
	public static final Block block = null;

	public AridsandstonepavementBlock(BydnahBlocksModElements instance) {
		super(instance, 558);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonepavement");
		}
