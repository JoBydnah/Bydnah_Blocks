...
public class JungleparquetBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jungleparquet")
	public static final Block block = null;

	public JungleparquetBlock(BydnahBlocksModElements instance) {
		super(instance, 346);
	}
