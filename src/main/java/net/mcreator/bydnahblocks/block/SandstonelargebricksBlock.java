...
public class SandstonelargebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonelargebricks")
	public static final Block block = null;

	public SandstonelargebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 495);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonelargebricks");
		}
