...
public class StoneCarvingGammaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:stone_carving_gamma")
	public static final Block block = null;

	public StoneCarvingGammaBlock(BydnahBlocksModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stone_carving_gamma");
		}
