...
public class AridsandstonepatternBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonepattern")
	public static final Block block = null;

	public AridsandstonepatternBlock(BydnahBlocksModElements instance) {
		super(instance, 557);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonepattern");
		}
