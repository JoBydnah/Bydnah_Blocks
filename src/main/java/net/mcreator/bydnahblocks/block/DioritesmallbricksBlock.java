...
public class DioritesmallbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritesmallbricks")
	public static final Block block = null;

	public DioritesmallbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 419);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioritesmallbricks");
		}
