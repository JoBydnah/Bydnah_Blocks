...
public class AcaciachaoticBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:acaciachaotic")
	public static final Block block = null;

	public AcaciachaoticBlock(BydnahBlocksModElements instance) {
		super(instance, 219);
	}
