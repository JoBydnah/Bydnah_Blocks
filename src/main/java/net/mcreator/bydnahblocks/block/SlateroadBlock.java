...
public class SlateroadBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slateroad")
	public static final Block block = null;

	public SlateroadBlock(BydnahBlocksModElements instance) {
		super(instance, 592);
	}
