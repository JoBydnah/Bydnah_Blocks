...
public class SlatesmallbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatesmallbricks")
	public static final Block block = null;

	public SlatesmallbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 593);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slatesmallbricks");
		}
