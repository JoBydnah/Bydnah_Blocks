...
public class LimestonepillarbaseBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:limestonepillarbase")
	public static final Block block = null;

	public LimestonepillarbaseBlock(BydnahBlocksModElements instance) {
		super(instance, 800);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("limestonepillarbase");
		}
