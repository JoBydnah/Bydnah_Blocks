...
public class DioritecobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritecobble")
	public static final Block block = null;

	public DioritecobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 355);
	}
