...
public class GraniteCarvingGammaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granite_carving_gamma")
	public static final Block block = null;

	public GraniteCarvingGammaBlock(BydnahBlocksModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("granite_carving_gamma");
		}
