...
public class BirchshippingcrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:birchshippingcrate")
	public static final Block block = null;

	public BirchshippingcrateBlock(BydnahBlocksModElements instance) {
		super(instance, 313);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("birchshippingcrate");
		}
