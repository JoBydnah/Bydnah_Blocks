...
public class StoneCarvingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:stone_carving")
	public static final Block block = null;

	public StoneCarvingBlock(BydnahBlocksModElements instance) {
		super(instance, 2);
	}
