...
public class AcaciacratesBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:acaciacrates")
	public static final Block block = null;

	public AcaciacratesBlock(BydnahBlocksModElements instance) {
		super(instance, 290);
	}
