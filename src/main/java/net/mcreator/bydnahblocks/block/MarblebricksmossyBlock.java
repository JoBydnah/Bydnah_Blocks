...
public class MarblebricksmossyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblebricksmossy")
	public static final Block block = null;

	public MarblebricksmossyBlock(BydnahBlocksModElements instance) {
		super(instance, 310);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marblebricksmossy");
		}
