...
public class SlateuniquebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slateuniquebricks")
	public static final Block block = null;

	public SlateuniquebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 602);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slateuniquebricks");
		}
