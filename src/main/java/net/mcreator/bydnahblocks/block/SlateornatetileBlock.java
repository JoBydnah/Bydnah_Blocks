...
public class SlateornatetileBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slateornatetile")
	public static final Block block = null;

	public SlateornatetileBlock(BydnahBlocksModElements instance) {
		super(instance, 587);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slateornatetile");
		}
