...
public class MarblecarvingdeltaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblecarvingdelta")
	public static final Block block = null;

	public MarblecarvingdeltaBlock(BydnahBlocksModElements instance) {
		super(instance, 319);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marblecarvingdelta");
		}
