...
public class MetalplatinggreenBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatinggreen")
	public static final Block block = null;

	public MetalplatinggreenBlock(BydnahBlocksModElements instance) {
		super(instance, 165);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatinggreen");
		}
