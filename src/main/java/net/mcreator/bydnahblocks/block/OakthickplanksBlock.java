...
public class OakthickplanksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:oakthickplanks")
	public static final Block block = null;

	public OakthickplanksBlock(BydnahBlocksModElements instance) {
		super(instance, 361);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("oakthickplanks");
		}
