...
public class PrimordialPlanksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:primordial_planks")
	public static final Block block = null;

	public PrimordialPlanksBlock(BydnahBlocksModElements instance) {
		super(instance, 738);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(4f, 5.223303379776745f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE));
			setRegistryName("primordial_planks");
		}
