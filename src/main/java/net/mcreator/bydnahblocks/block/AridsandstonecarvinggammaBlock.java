...
public class AridsandstonecarvinggammaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonecarvinggamma")
	public static final Block block = null;

	public AridsandstonecarvinggammaBlock(BydnahBlocksModElements instance) {
		super(instance, 575);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonecarvinggamma");
		}
