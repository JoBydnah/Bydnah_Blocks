...
public class MarblepatternBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblepattern")
	public static final Block block = null;

	public MarblepatternBlock(BydnahBlocksModElements instance) {
		super(instance, 417);
	}
