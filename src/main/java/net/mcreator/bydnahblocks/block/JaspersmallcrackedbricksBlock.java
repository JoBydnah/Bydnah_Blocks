...
public class JaspersmallcrackedbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jaspersmallcrackedbricks")
	public static final Block block = null;

	public JaspersmallcrackedbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 620);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jaspersmallcrackedbricks");
		}
