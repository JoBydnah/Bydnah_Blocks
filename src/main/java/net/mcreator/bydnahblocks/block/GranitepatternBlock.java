...
public class GranitepatternBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitepattern")
	public static final Block block = null;

	public GranitepatternBlock(BydnahBlocksModElements instance) {
		super(instance, 386);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitepattern");
		}
