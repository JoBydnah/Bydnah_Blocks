...
public class CopperscaffoldBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:copperscaffold")
	public static final Block block = null;

	public CopperscaffoldBlock(BydnahBlocksModElements instance) {
		super(instance, 94);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("copperscaffold");
		}
