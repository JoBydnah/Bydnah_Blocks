...
public class JadeOreBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jade_ore")
	public static final Block block = null;

	public JadeOreBlock(BydnahBlocksModElements instance) {
		super(instance, 51);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("bydnah_blocks:jade_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("bydnah_blocks:jade_ore"), configuredFeature);
		}
	}
