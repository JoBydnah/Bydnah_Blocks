...
public class RedrocksandstonepatternBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonepattern")
	public static final Block block = null;

	public RedrocksandstonepatternBlock(BydnahBlocksModElements instance) {
		super(instance, 642);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonepattern");
		}
