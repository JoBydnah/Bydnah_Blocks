...
public class SlateornateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slateornate")
	public static final Block block = null;

	public SlateornateBlock(BydnahBlocksModElements instance) {
		super(instance, 586);
	}
