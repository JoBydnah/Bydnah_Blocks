...
public class RedrocksandstoneuniquebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstoneuniquebricks")
	public static final Block block = null;

	public RedrocksandstoneuniquebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 656);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstoneuniquebricks");
		}
