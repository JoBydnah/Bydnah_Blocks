...
public class PlatinumcasingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:platinumcasing")
	public static final Block block = null;

	public PlatinumcasingBlock(BydnahBlocksModElements instance) {
		super(instance, 138);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("platinumcasing");
		}
