...
public class GraniteCarvingDeltaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granite_carving_delta")
	public static final Block block = null;

	public GraniteCarvingDeltaBlock(BydnahBlocksModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("granite_carving_delta");
		}
