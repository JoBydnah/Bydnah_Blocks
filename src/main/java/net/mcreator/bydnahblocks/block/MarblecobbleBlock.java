...
public class MarblecobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblecobble")
	public static final Block block = null;

	public MarblecobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 312);
	}
