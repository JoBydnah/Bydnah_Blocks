...
public class TincrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:tincrate")
	public static final Block block = null;

	public TincrateBlock(BydnahBlocksModElements instance) {
		super(instance, 115);
	}
