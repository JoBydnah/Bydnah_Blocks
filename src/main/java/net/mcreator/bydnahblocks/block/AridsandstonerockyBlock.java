...
public class AridsandstonerockyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonerocky")
	public static final Block block = null;

	public AridsandstonerockyBlock(BydnahBlocksModElements instance) {
		super(instance, 561);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonerocky");
		}
