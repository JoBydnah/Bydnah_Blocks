...
public class SlatetwinBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatetwin")
	public static final Block block = null;

	public SlatetwinBlock(BydnahBlocksModElements instance) {
		super(instance, 601);
	}
