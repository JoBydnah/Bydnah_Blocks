...
public class StoneCoarseBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:stone_coarse")
	public static final Block block = null;

	public StoneCoarseBlock(BydnahBlocksModElements instance) {
		super(instance, 352);
	}
