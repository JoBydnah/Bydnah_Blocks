...
public class MarbleroadBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marbleroad")
	public static final Block block = null;

	public MarbleroadBlock(BydnahBlocksModElements instance) {
		super(instance, 415);
	}
