...
public class RustyironBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:rustyiron")
	public static final Block block = null;

	public RustyironBlock(BydnahBlocksModElements instance) {
		super(instance, 156);
	}
