...
public class ReinforcedplatingredBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatingred")
	public static final Block block = null;

	public ReinforcedplatingredBlock(BydnahBlocksModElements instance) {
		super(instance, 286);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatingred");
		}
