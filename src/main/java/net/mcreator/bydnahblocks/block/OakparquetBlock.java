...
public class OakparquetBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:oakparquet")
	public static final Block block = null;

	public OakparquetBlock(BydnahBlocksModElements instance) {
		super(instance, 278);
	}
