...
public class PrimordialPressurePlateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:primordial_pressure_plate")
	public static final Block block = null;

	public PrimordialPressurePlateBlock(BydnahBlocksModElements instance) {
		super(instance, 744);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("primordial_pressure_plate");
		}
