...
public class AndesiteornatetileBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesiteornatetile")
	public static final Block block = null;

	public AndesiteornatetileBlock(BydnahBlocksModElements instance) {
		super(instance, 454);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesiteornatetile");
		}
