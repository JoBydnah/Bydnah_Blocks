...
public class AridsandstonechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonechiseled")
	public static final Block block = null;

	public AridsandstonechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 544);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonechiseled");
		}
