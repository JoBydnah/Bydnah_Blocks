...
public class OakshippingcrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:oakshippingcrate")
	public static final Block block = null;

	public OakshippingcrateBlock(BydnahBlocksModElements instance) {
		super(instance, 279);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("oakshippingcrate");
		}
