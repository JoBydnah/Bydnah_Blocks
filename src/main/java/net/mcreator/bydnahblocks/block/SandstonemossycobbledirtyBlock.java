...
public class SandstonemossycobbledirtyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonemossycobbledirty")
	public static final Block block = null;

	public SandstonemossycobbledirtyBlock(BydnahBlocksModElements instance) {
		super(instance, 498);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonemossycobbledirty");
		}
