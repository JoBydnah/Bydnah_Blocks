...
public class OakwideplanksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:oakwideplanks")
	public static final Block block = null;

	public OakwideplanksBlock(BydnahBlocksModElements instance) {
		super(instance, 364);
	}
