...
public class MarblecobblemossyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblecobblemossy")
	public static final Block block = null;

	public MarblecobblemossyBlock(BydnahBlocksModElements instance) {
		super(instance, 313);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marblecobblemossy");
		}
