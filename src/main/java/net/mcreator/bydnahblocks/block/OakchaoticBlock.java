...
public class OakchaoticBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:oakchaotic")
	public static final Block block = null;

	public OakchaoticBlock(BydnahBlocksModElements instance) {
		super(instance, 352);
	}
