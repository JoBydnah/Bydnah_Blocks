...
public class ReinforcedplatingbrownBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatingbrown")
	public static final Block block = null;

	public ReinforcedplatingbrownBlock(BydnahBlocksModElements instance) {
		super(instance, 275);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatingbrown");
		}
