...
public class DioritefancyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritefancy")
	public static final Block block = null;

	public DioritefancyBlock(BydnahBlocksModElements instance) {
		super(instance, 475);
	}
