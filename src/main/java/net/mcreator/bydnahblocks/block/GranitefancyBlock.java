...
public class GranitefancyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitefancy")
	public static final Block block = null;

	public GranitefancyBlock(BydnahBlocksModElements instance) {
		super(instance, 365);
	}
