...
public class AndesitechaoticBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitechaotic")
	public static final Block block = null;

	public AndesitechaoticBlock(BydnahBlocksModElements instance) {
		super(instance, 534);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitechaotic");
		}
