...
public class SteeldoorBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:steeldoor")
	public static final Block block = null;

	public SteeldoorBlock(BydnahBlocksModElements instance) {
		super(instance, 315);
	}
