...
public class CobalthazardBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:cobalthazard")
	public static final Block block = null;

	public CobalthazardBlock(BydnahBlocksModElements instance) {
		super(instance, 105);
	}
