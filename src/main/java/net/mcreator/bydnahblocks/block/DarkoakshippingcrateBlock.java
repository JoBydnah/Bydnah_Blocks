...
public class DarkoakshippingcrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:darkoakshippingcrate")
	public static final Block block = null;

	public DarkoakshippingcrateBlock(BydnahBlocksModElements instance) {
		super(instance, 334);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("darkoakshippingcrate");
		}
