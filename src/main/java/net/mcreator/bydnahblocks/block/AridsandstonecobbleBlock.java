...
public class AridsandstonecobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonecobble")
	public static final Block block = null;

	public AridsandstonecobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 546);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonecobble");
		}
