...
public class SandstonetilessmallBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonetilessmall")
	public static final Block block = null;

	public SandstonetilessmallBlock(BydnahBlocksModElements instance) {
		super(instance, 508);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonetilessmall");
		}
