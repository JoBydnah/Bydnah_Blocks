...
public class MarbletwinlargechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marbletwinlargechiseled")
	public static final Block block = null;

	public MarbletwinlargechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 331);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletwinlargechiseled");
		}
