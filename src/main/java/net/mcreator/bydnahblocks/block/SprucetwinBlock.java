...
public class SprucetwinBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sprucetwin")
	public static final Block block = null;

	public SprucetwinBlock(BydnahBlocksModElements instance) {
		super(instance, 375);
	}
