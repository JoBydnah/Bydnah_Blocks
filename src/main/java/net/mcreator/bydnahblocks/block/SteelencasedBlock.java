...
public class SteelencasedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:steelencased")
	public static final Block block = null;

	public SteelencasedBlock(BydnahBlocksModElements instance) {
		super(instance, 190);
	}
