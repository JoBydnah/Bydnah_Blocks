...
public class AridsandstonetwinsideBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonetwinside")
	public static final Block block = null;

	public AridsandstonetwinsideBlock(BydnahBlocksModElements instance) {
		super(instance, 569);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonetwinside");
		}
