...
public class BydnahriteBlockBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:bydnahrite_block")
	public static final Block block = null;

	public BydnahriteBlockBlock(BydnahBlocksModElements instance) {
		super(instance, 706);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bydnahrite_block");
		}
