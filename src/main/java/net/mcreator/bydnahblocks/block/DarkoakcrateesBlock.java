...
public class DarkoakcrateesBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:darkoakcratees")
	public static final Block block = null;

	public DarkoakcrateesBlock(BydnahBlocksModElements instance) {
		super(instance, 330);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("darkoakcratees");
		}
