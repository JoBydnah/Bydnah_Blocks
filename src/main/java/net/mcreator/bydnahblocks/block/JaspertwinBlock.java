...
public class JaspertwinBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jaspertwin")
	public static final Block block = null;

	public JaspertwinBlock(BydnahBlocksModElements instance) {
		super(instance, 627);
	}
