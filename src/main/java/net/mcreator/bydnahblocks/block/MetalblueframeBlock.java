...
public class MetalblueframeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalblueframe")
	public static final Block block = null;

	public MetalblueframeBlock(BydnahBlocksModElements instance) {
		super(instance, 160);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalblueframe");
		}
