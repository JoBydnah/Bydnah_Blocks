...
public class SandstonesmallbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonesmallbricks")
	public static final Block block = null;

	public SandstonesmallbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 505);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonesmallbricks");
		}
