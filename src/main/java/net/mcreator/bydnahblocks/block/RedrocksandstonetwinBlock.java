...
public class RedrocksandstonetwinBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonetwin")
	public static final Block block = null;

	public RedrocksandstonetwinBlock(BydnahBlocksModElements instance) {
		super(instance, 655);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonetwin");
		}
