...
public class MetalplatingblackBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatingblack")
	public static final Block block = null;

	public MetalplatingblackBlock(BydnahBlocksModElements instance) {
		super(instance, 160);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatingblack");
		}
