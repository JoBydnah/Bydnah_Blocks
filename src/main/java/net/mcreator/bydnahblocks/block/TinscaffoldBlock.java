...
public class TinscaffoldBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:tinscaffold")
	public static final Block block = null;

	public TinscaffoldBlock(BydnahBlocksModElements instance) {
		super(instance, 118);
	}
