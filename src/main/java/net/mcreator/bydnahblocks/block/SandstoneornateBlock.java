...
public class SandstoneornateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstoneornate")
	public static final Block block = null;

	public SandstoneornateBlock(BydnahBlocksModElements instance) {
		super(instance, 499);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstoneornate");
		}
