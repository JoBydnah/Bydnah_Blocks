...
public class JungletwinBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jungletwin")
	public static final Block block = null;

	public JungletwinBlock(BydnahBlocksModElements instance) {
		super(instance, 268);
	}
