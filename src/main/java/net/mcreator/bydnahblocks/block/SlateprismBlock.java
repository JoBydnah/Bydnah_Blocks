...
public class SlateprismBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slateprism")
	public static final Block block = null;

	public SlateprismBlock(BydnahBlocksModElements instance) {
		super(instance, 591);
	}
