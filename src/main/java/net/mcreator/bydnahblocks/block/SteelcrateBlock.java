...
public class SteelcrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:steelcrate")
	public static final Block block = null;

	public SteelcrateBlock(BydnahBlocksModElements instance) {
		super(instance, 189);
	}
