...
public class SilverboltedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:silverbolted")
	public static final Block block = null;

	public SilverboltedBlock(BydnahBlocksModElements instance) {
		super(instance, 206);
	}
