...
public class JadestoneCarvingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_carving")
	public static final Block block = null;

	public JadestoneCarvingBlock(BydnahBlocksModElements instance) {
		super(instance, 63);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jadestone_carving");
		}
