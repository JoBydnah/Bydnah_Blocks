...
public class TinboltedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:tinbolted")
	public static final Block block = null;

	public TinboltedBlock(BydnahBlocksModElements instance) {
		super(instance, 193);
	}
