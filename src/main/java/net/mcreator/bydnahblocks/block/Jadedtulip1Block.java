...
public class Jadedtulip1Block extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadedtulip_lime")
	public static final Block block = null;

	public Jadedtulip1Block(BydnahBlocksModElements instance) {
		super(instance, 817);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("jadedtulip_lime"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("bydnah_blocks:jadedtulip_lime"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("jadedtulip_lime");
		}
