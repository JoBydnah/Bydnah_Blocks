...
public class JunglethickbeamsBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:junglethickbeams")
	public static final Block block = null;

	public JunglethickbeamsBlock(BydnahBlocksModElements instance) {
		super(instance, 348);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("junglethickbeams");
		}
