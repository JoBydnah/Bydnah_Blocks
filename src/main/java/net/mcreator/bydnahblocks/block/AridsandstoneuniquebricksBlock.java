...
public class AridsandstoneuniquebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstoneuniquebricks")
	public static final Block block = null;

	public AridsandstoneuniquebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 570);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstoneuniquebricks");
		}
