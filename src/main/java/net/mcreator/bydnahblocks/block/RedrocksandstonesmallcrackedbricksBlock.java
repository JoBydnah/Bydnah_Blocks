...
public class RedrocksandstonesmallcrackedbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonesmallcrackedbricks")
	public static final Block block = null;

	public RedrocksandstonesmallcrackedbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 648);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonesmallcrackedbricks");
		}
