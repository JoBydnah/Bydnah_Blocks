...
public class ReinforcedplatingorangeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatingorange")
	public static final Block block = null;

	public ReinforcedplatingorangeBlock(BydnahBlocksModElements instance) {
		super(instance, 202);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatingorange");
		}
