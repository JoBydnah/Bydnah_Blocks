...
public class PrimordialDoorBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:primordial_door")
	public static final Block block = null;

	public PrimordialDoorBlock(BydnahBlocksModElements instance) {
		super(instance, 763);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("primordial_door");
		}
