...
public class Rustydoor2Block extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:rustydoor_2")
	public static final Block block = null;

	public Rustydoor2Block(BydnahBlocksModElements instance) {
		super(instance, 382);
	}
