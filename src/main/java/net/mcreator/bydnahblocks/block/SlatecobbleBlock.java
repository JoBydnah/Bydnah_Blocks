...
public class SlatecobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatecobble")
	public static final Block block = null;

	public SlatecobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 581);
	}
