...
public class BirchcleanBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:birchclean")
	public static final Block block = null;

	public BirchcleanBlock(BydnahBlocksModElements instance) {
		super(instance, 221);
	}
