...
public class JaspercoarseBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jaspercoarse")
	public static final Block block = null;

	public JaspercoarseBlock(BydnahBlocksModElements instance) {
		super(instance, 606);
	}
