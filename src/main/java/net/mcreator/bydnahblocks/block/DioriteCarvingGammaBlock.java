...
public class DioriteCarvingGammaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:diorite_carving_gamma")
	public static final Block block = null;

	public DioriteCarvingGammaBlock(BydnahBlocksModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("diorite_carving_gamma");
		}
