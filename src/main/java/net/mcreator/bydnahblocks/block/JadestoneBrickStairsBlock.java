...
public class JadestoneBrickStairsBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_brick_stairs")
	public static final Block block = null;

	public JadestoneBrickStairsBlock(BydnahBlocksModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("jadestone_brick_stairs");
		}
