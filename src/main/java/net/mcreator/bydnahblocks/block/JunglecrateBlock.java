...
public class JunglecrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:junglecrate")
	public static final Block block = null;

	public JunglecrateBlock(BydnahBlocksModElements instance) {
		super(instance, 260);
	}
