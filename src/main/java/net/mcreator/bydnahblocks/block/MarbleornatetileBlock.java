...
public class MarbleornatetileBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marbleornatetile")
	public static final Block block = null;

	public MarbleornatetileBlock(BydnahBlocksModElements instance) {
		super(instance, 414);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbleornatetile");
		}
