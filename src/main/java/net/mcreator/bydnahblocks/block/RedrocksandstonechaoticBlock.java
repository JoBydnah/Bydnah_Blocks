...
public class RedrocksandstonechaoticBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonechaotic")
	public static final Block block = null;

	public RedrocksandstonechaoticBlock(BydnahBlocksModElements instance) {
		super(instance, 631);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonechaotic");
		}
