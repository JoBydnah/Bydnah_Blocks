...
public class PrimordialButtonBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:primordial_button")
	public static final Block block = null;

	public PrimordialButtonBlock(BydnahBlocksModElements instance) {
		super(instance, 745);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("primordial_button");
		}
