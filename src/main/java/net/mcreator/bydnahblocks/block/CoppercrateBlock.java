...
public class CoppercrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:coppercrate")
	public static final Block block = null;

	public CoppercrateBlock(BydnahBlocksModElements instance) {
		super(instance, 171);
	}
