...
public class SteeltrapdoorBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:steeltrapdoor")
	public static final Block block = null;

	public SteeltrapdoorBlock(BydnahBlocksModElements instance) {
		super(instance, 378);
	}
