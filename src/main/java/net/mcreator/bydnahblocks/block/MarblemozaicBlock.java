...
public class MarblemozaicBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblemozaic")
	public static final Block block = null;

	public MarblemozaicBlock(BydnahBlocksModElements instance) {
		super(instance, 330);
	}
