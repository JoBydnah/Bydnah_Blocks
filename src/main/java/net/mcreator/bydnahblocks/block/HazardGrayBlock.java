...
public class HazardGrayBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:hazard_gray")
	public static final Block block = null;

	public HazardGrayBlock(BydnahBlocksModElements instance) {
		super(instance, 32);
	}
