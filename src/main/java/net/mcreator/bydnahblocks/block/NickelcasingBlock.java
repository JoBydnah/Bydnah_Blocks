...
public class NickelcasingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:nickelcasing")
	public static final Block block = null;

	public NickelcasingBlock(BydnahBlocksModElements instance) {
		super(instance, 213);
	}
