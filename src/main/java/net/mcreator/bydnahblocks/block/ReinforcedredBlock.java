...
public class ReinforcedredBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedred")
	public static final Block block = null;

	public ReinforcedredBlock(BydnahBlocksModElements instance) {
		super(instance, 270);
	}
