...
public class DioriteCarvingDeltaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:diorite_carving_delta")
	public static final Block block = null;

	public DioriteCarvingDeltaBlock(BydnahBlocksModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("diorite_carving_delta");
		}
