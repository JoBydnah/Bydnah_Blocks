...
public class AridsandstonecoarseBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonecoarse")
	public static final Block block = null;

	public AridsandstonecoarseBlock(BydnahBlocksModElements instance) {
		super(instance, 545);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonecoarse");
		}
