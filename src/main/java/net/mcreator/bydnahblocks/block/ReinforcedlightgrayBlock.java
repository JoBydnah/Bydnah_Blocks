...
public class ReinforcedlightgrayBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedlightgray")
	public static final Block block = null;

	public ReinforcedlightgrayBlock(BydnahBlocksModElements instance) {
		super(instance, 183);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedlightgray");
		}
