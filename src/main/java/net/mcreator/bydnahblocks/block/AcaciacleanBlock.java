...
public class AcaciacleanBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:acaciaclean")
	public static final Block block = null;

	public AcaciacleanBlock(BydnahBlocksModElements instance) {
		super(instance, 294);
	}
