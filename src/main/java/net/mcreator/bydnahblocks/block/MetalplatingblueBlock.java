...
public class MetalplatingblueBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatingblue")
	public static final Block block = null;

	public MetalplatingblueBlock(BydnahBlocksModElements instance) {
		super(instance, 161);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatingblue");
		}
