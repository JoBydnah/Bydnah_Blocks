...
public class PlatinumcrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:platinumcrate")
	public static final Block block = null;

	public PlatinumcrateBlock(BydnahBlocksModElements instance) {
		super(instance, 220);
	}
