...
public class ReinforcedplatingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplating")
	public static final Block block = null;

	public ReinforcedplatingBlock(BydnahBlocksModElements instance) {
		super(instance, 306);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplating");
		}
