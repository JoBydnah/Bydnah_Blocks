...
public class ReinforcedpurpleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedpurple")
	public static final Block block = null;

	public ReinforcedpurpleBlock(BydnahBlocksModElements instance) {
		super(instance, 269);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedpurple");
		}
