...
public class StoneCarvingAlphaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:stone_carving_alpha")
	public static final Block block = null;

	public StoneCarvingAlphaBlock(BydnahBlocksModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stone_carving_alpha");
		}
