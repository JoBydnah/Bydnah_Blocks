...
public class JadetoneBrickSlabBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadetone_brick_slab")
	public static final Block block = null;

	public JadetoneBrickSlabBlock(BydnahBlocksModElements instance) {
		super(instance, 148);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("jadetone_brick_slab");
		}
