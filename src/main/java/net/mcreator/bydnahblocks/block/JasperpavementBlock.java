...
public class JasperpavementBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jasperpavement")
	public static final Block block = null;

	public JasperpavementBlock(BydnahBlocksModElements instance) {
		super(instance, 616);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jasperpavement");
		}
