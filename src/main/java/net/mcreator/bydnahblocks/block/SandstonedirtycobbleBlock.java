...
public class SandstonedirtycobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonedirtycobble")
	public static final Block block = null;

	public SandstonedirtycobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 492);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonedirtycobble");
		}
