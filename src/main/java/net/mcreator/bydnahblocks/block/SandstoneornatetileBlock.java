...
public class SandstoneornatetileBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstoneornatetile")
	public static final Block block = null;

	public SandstoneornatetileBlock(BydnahBlocksModElements instance) {
		super(instance, 501);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstoneornatetile");
		}
