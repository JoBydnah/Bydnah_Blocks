...
public class SlatechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatechiseled")
	public static final Block block = null;

	public SlatechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 579);
	}
