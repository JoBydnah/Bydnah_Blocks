...
public class LimestonecobblepillarbaseBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:limestonecobblepillarbase")
	public static final Block block = null;

	public LimestonecobblepillarbaseBlock(BydnahBlocksModElements instance) {
		super(instance, 799);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("limestonecobblepillarbase");
		}
