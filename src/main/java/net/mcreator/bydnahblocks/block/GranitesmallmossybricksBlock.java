...
public class GranitesmallmossybricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitesmallmossybricks")
	public static final Block block = null;

	public GranitesmallmossybricksBlock(BydnahBlocksModElements instance) {
		super(instance, 426);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitesmallmossybricks");
		}
