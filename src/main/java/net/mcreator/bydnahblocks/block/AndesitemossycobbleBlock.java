...
public class AndesitemossycobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitemossycobble")
	public static final Block block = null;

	public AndesitemossycobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 404);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitemossycobble");
		}
