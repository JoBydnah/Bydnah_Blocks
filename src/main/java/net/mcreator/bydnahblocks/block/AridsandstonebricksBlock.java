...
public class AridsandstonebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonebricks")
	public static final Block block = null;

	public AridsandstonebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 542);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonebricks");
		}
