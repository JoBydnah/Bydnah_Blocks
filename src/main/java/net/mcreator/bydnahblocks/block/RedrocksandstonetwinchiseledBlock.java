...
public class RedrocksandstonetwinchiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonetwinchiseled")
	public static final Block block = null;

	public RedrocksandstonetwinchiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 653);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonetwinchiseled");
		}
