...
public class SandstonechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonechiseled")
	public static final Block block = null;

	public SandstonechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 490);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonechiseled");
		}
