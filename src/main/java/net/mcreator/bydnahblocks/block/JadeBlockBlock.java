...
public class JadeBlockBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jade_block")
	public static final Block block = null;

	public JadeBlockBlock(BydnahBlocksModElements instance) {
		super(instance, 51);
	}
