...
public class ReinforcedwhiteBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedwhite")
	public static final Block block = null;

	public ReinforcedwhiteBlock(BydnahBlocksModElements instance) {
		super(instance, 190);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedwhite");
		}
