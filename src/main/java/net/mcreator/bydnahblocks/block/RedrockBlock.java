...
public class RedrockBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrock")
	public static final Block block = null;

	public RedrockBlock(BydnahBlocksModElements instance) {
		super(instance, 629);
	}
