...
public class MarbletilesmediumBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marbletilesmedium")
	public static final Block block = null;

	public MarbletilesmediumBlock(BydnahBlocksModElements instance) {
		super(instance, 325);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletilesmedium");
		}
