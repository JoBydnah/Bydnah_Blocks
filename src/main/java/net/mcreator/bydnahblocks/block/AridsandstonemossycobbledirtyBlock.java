...
public class AridsandstonemossycobbledirtyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonemossycobbledirty")
	public static final Block block = null;

	public AridsandstonemossycobbledirtyBlock(BydnahBlocksModElements instance) {
		super(instance, 553);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonemossycobbledirty");
		}
