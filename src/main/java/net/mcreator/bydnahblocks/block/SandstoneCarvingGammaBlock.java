...
public class SandstoneCarvingGammaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstone_carving_gamma")
	public static final Block block = null;

	public SandstoneCarvingGammaBlock(BydnahBlocksModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstone_carving_gamma");
		}
