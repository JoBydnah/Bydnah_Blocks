...
public class ReinforcedmagentaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedmagenta")
	public static final Block block = null;

	public ReinforcedmagentaBlock(BydnahBlocksModElements instance) {
		super(instance, 185);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedmagenta");
		}
