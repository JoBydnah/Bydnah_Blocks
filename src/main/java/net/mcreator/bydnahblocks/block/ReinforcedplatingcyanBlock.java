...
public class ReinforcedplatingcyanBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatingcyan")
	public static final Block block = null;

	public ReinforcedplatingcyanBlock(BydnahBlocksModElements instance) {
		super(instance, 276);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatingcyan");
		}
