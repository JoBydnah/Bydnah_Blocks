...
public class ReinforcedblueBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedblue")
	public static final Block block = null;

	public ReinforcedblueBlock(BydnahBlocksModElements instance) {
		super(instance, 177);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedblue");
		}
