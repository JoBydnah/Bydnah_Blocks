...
public class DioriteCarvingAlphaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:diorite_carving_alpha")
	public static final Block block = null;

	public DioriteCarvingAlphaBlock(BydnahBlocksModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("diorite_carving_alpha");
		}
