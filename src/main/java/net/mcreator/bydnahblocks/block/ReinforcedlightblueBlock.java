...
public class ReinforcedlightblueBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedlightblue")
	public static final Block block = null;

	public ReinforcedlightblueBlock(BydnahBlocksModElements instance) {
		super(instance, 182);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedlightblue");
		}
