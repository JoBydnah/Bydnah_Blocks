...
public class BrickHerringboneBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:brick_herringbone")
	public static final Block block = null;

	public BrickHerringboneBlock(BydnahBlocksModElements instance) {
		super(instance, 457);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brick_herringbone");
		}
