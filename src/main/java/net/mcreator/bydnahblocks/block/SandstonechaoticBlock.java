...
public class SandstonechaoticBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonechaotic")
	public static final Block block = null;

	public SandstonechaoticBlock(BydnahBlocksModElements instance) {
		super(instance, 489);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonechaotic");
		}
