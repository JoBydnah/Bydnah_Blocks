...
public class IronboltedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:ironbolted")
	public static final Block block = null;

	public IronboltedBlock(BydnahBlocksModElements instance) {
		super(instance, 86);
	}
