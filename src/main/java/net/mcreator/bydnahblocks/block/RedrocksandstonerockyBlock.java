...
public class RedrocksandstonerockyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonerocky")
	public static final Block block = null;

	public RedrocksandstonerockyBlock(BydnahBlocksModElements instance) {
		super(instance, 646);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonerocky");
		}
