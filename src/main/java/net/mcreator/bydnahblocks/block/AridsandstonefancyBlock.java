...
public class AridsandstonefancyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonefancy")
	public static final Block block = null;

	public AridsandstonefancyBlock(BydnahBlocksModElements instance) {
		super(instance, 548);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonefancy");
		}
