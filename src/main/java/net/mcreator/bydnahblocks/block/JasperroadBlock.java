...
public class JasperroadBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jasperroad")
	public static final Block block = null;

	public JasperroadBlock(BydnahBlocksModElements instance) {
		super(instance, 618);
	}
