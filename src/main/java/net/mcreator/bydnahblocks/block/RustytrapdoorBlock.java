...
public class RustytrapdoorBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:rustytrapdoor")
	public static final Block block = null;

	public RustytrapdoorBlock(BydnahBlocksModElements instance) {
		super(instance, 304);
	}
