...
public class AndesitefancyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitefancy")
	public static final Block block = null;

	public AndesitefancyBlock(BydnahBlocksModElements instance) {
		super(instance, 452);
	}
