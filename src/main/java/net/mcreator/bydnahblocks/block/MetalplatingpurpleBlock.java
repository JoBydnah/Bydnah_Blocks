...
public class MetalplatingpurpleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatingpurple")
	public static final Block block = null;

	public MetalplatingpurpleBlock(BydnahBlocksModElements instance) {
		super(instance, 253);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatingpurple");
		}
