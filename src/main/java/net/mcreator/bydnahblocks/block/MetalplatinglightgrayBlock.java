...
public class MetalplatinglightgrayBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatinglightgray")
	public static final Block block = null;

	public MetalplatinglightgrayBlock(BydnahBlocksModElements instance) {
		super(instance, 248);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatinglightgray");
		}
