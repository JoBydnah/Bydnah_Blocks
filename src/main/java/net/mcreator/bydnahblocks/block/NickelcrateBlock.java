...
public class NickelcrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:nickelcrate")
	public static final Block block = null;

	public NickelcrateBlock(BydnahBlocksModElements instance) {
		super(instance, 133);
	}
