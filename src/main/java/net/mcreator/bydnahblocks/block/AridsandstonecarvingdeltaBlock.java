...
public class AridsandstonecarvingdeltaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonecarvingdelta")
	public static final Block block = null;

	public AridsandstonecarvingdeltaBlock(BydnahBlocksModElements instance) {
		super(instance, 574);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonecarvingdelta");
		}
