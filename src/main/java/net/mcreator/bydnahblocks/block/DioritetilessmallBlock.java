...
public class DioritetilessmallBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritetilessmall")
	public static final Block block = null;

	public DioritetilessmallBlock(BydnahBlocksModElements instance) {
		super(instance, 378);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioritetilessmall");
		}
