...
public class JunglecleanBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jungleclean")
	public static final Block block = null;

	public JunglecleanBlock(BydnahBlocksModElements instance) {
		super(instance, 259);
	}
