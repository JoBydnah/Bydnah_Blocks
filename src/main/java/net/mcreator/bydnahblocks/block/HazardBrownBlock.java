...
public class HazardBrownBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:hazard_brown")
	public static final Block block = null;

	public HazardBrownBlock(BydnahBlocksModElements instance) {
		super(instance, 35);
	}
