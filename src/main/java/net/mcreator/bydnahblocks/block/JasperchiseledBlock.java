...
public class JasperchiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jasperchiseled")
	public static final Block block = null;

	public JasperchiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 605);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jasperchiseled");
		}
