...
public class PrimordialFenceGateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:primordial_fence_gate")
	public static final Block block = null;

	public PrimordialFenceGateBlock(BydnahBlocksModElements instance) {
		super(instance, 743);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("primordial_fence_gate");
		}
