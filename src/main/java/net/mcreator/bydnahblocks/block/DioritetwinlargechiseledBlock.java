...
public class DioritetwinlargechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritetwinlargechiseled")
	public static final Block block = null;

	public DioritetwinlargechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 484);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioritetwinlargechiseled");
		}
