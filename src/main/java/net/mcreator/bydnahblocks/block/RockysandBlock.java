...
public class RockysandBlock extends BydnahBlocksModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("bydnah_blocks:rockysand_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("rockysand"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("bydnah_blocks:rockysand"), configuredFeature);
		}
	}
