...
public class BirchtwinBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:birchtwin")
	public static final Block block = null;

	public BirchtwinBlock(BydnahBlocksModElements instance) {
		super(instance, 310);
	}
