...
public class IronscaffoldBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:ironscaffold")
	public static final Block block = null;

	public IronscaffoldBlock(BydnahBlocksModElements instance) {
		super(instance, 85);
	}
