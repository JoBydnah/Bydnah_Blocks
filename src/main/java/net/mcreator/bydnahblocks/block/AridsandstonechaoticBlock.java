...
public class AridsandstonechaoticBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonechaotic")
	public static final Block block = null;

	public AridsandstonechaoticBlock(BydnahBlocksModElements instance) {
		super(instance, 543);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonechaotic");
		}
