...
public class RustydotsBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:rustydots")
	public static final Block block = null;

	public RustydotsBlock(BydnahBlocksModElements instance) {
		super(instance, 77);
	}
