...
public class MarblebrickslargeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblebrickslarge")
	public static final Block block = null;

	public MarblebrickslargeBlock(BydnahBlocksModElements instance) {
		super(instance, 321);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marblebrickslarge");
		}
