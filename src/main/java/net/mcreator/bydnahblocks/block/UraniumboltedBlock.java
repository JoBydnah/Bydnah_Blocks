...
public class UraniumboltedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:uraniumbolted")
	public static final Block block = null;

	public UraniumboltedBlock(BydnahBlocksModElements instance) {
		super(instance, 119);
	}
