...
public class HazardLimeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:hazard_lime")
	public static final Block block = null;

	public HazardLimeBlock(BydnahBlocksModElements instance) {
		super(instance, 84);
	}
