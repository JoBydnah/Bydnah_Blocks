...
public class SlatetileslargeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatetileslarge")
	public static final Block block = null;

	public SlatetileslargeBlock(BydnahBlocksModElements instance) {
		super(instance, 595);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slatetileslarge");
		}
