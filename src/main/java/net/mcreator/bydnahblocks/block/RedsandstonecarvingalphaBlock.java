...
public class RedsandstonecarvingalphaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redsandstonecarvingalpha")
	public static final Block block = null;

	public RedsandstonecarvingalphaBlock(BydnahBlocksModElements instance) {
		super(instance, 108);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redsandstonecarvingalpha");
		}
