...
public class GraniteornateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:graniteornate")
	public static final Block block = null;

	public GraniteornateBlock(BydnahBlocksModElements instance) {
		super(instance, 366);
	}
