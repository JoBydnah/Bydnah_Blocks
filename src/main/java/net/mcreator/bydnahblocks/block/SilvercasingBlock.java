...
public class SilvercasingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:silvercasing")
	public static final Block block = null;

	public SilvercasingBlock(BydnahBlocksModElements instance) {
		super(instance, 126);
	}
