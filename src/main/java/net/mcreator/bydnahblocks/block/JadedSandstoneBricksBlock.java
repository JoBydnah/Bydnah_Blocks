...
public class JadedSandstoneBricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jaded_sandstone_bricks")
	public static final Block block = null;

	public JadedSandstoneBricksBlock(BydnahBlocksModElements instance) {
		super(instance, 56);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jaded_sandstone_bricks");
		}
