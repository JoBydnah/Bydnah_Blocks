...
public class DioriteornatebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioriteornatebricks")
	public static final Block block = null;

	public DioriteornatebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 478);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioriteornatebricks");
		}
