...
public class AridsandstonetileslargeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonetileslarge")
	public static final Block block = null;

	public AridsandstonetileslargeBlock(BydnahBlocksModElements instance) {
		super(instance, 564);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonetileslarge");
		}
