...
public class JaspertilesmozaicBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jaspertilesmozaic")
	public static final Block block = null;

	public JaspertilesmozaicBlock(BydnahBlocksModElements instance) {
		super(instance, 623);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jaspertilesmozaic");
		}
