...
public class AndesiteCarvingGammaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesite_carving_gamma")
	public static final Block block = null;

	public AndesiteCarvingGammaBlock(BydnahBlocksModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("andesite_carving_gamma");
		}
