...
public class RedrocksandstonefancyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonefancy")
	public static final Block block = null;

	public RedrocksandstonefancyBlock(BydnahBlocksModElements instance) {
		super(instance, 635);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonefancy");
		}
