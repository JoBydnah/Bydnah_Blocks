...
public class DarkoaktwinBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:darkoaktwin")
	public static final Block block = null;

	public DarkoaktwinBlock(BydnahBlocksModElements instance) {
		super(instance, 255);
	}
