...
public class DarkoakchaoticBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:darkoakchaotic")
	public static final Block block = null;

	public DarkoakchaoticBlock(BydnahBlocksModElements instance) {
		super(instance, 246);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("darkoakchaotic");
		}
