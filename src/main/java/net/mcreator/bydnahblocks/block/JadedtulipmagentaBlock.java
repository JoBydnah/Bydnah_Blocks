...
public class JadedtulipmagentaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadedtulipmagenta")
	public static final Block block = null;

	public JadedtulipmagentaBlock(BydnahBlocksModElements instance) {
		super(instance, 819);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("jadedtulipmagenta"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("bydnah_blocks:jadedtulipmagenta"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("jadedtulipmagenta");
		}
