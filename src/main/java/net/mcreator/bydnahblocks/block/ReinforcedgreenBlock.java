...
public class ReinforcedgreenBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedgreen")
	public static final Block block = null;

	public ReinforcedgreenBlock(BydnahBlocksModElements instance) {
		super(instance, 262);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedgreen");
		}
