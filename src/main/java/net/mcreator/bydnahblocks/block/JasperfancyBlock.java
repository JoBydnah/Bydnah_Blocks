...
public class JasperfancyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jasperfancy")
	public static final Block block = null;

	public JasperfancyBlock(BydnahBlocksModElements instance) {
		super(instance, 608);
	}
