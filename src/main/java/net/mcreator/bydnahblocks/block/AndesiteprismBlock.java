...
public class AndesiteprismBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesiteprism")
	public static final Block block = null;

	public AndesiteprismBlock(BydnahBlocksModElements instance) {
		super(instance, 372);
	}
