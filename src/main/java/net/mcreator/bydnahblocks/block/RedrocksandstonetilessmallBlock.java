...
public class RedrocksandstonetilessmallBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonetilessmall")
	public static final Block block = null;

	public RedrocksandstonetilessmallBlock(BydnahBlocksModElements instance) {
		super(instance, 652);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonetilessmall");
		}
