...
public class SlatemossycobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatemossycobble")
	public static final Block block = null;

	public SlatemossycobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 585);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slatemossycobble");
		}
