...
public class BirchparquetBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:birchparquet")
	public static final Block block = null;

	public BirchparquetBlock(BydnahBlocksModElements instance) {
		super(instance, 227);
	}
