...
public class AcaciashippingcrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:acaciashippingcrate")
	public static final Block block = null;

	public AcaciashippingcrateBlock(BydnahBlocksModElements instance) {
		super(instance, 233);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("acaciashippingcrate");
		}
