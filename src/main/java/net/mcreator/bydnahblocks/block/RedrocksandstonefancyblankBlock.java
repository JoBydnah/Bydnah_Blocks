...
public class RedrocksandstonefancyblankBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonefancyblank")
	public static final Block block = null;

	public RedrocksandstonefancyblankBlock(BydnahBlocksModElements instance) {
		super(instance, 636);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonefancyblank");
		}
