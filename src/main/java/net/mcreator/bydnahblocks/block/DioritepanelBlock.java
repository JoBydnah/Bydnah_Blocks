...
public class DioritepanelBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritepanel")
	public static final Block block = null;

	public DioritepanelBlock(BydnahBlocksModElements instance) {
		super(instance, 480);
	}
