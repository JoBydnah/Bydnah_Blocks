...
public class ReinforcedplatinggrayBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatinggray")
	public static final Block block = null;

	public ReinforcedplatinggrayBlock(BydnahBlocksModElements instance) {
		super(instance, 196);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatinggray");
		}
