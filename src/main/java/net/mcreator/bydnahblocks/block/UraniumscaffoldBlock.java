...
public class UraniumscaffoldBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:uraniumscaffold")
	public static final Block block = null;

	public UraniumscaffoldBlock(BydnahBlocksModElements instance) {
		super(instance, 205);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uraniumscaffold");
		}
