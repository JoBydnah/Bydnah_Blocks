...
public class MarblecarvinggammaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblecarvinggamma")
	public static final Block block = null;

	public MarblecarvinggammaBlock(BydnahBlocksModElements instance) {
		super(instance, 318);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marblecarvinggamma");
		}
