...
public class ReinforcedpinkBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedpink")
	public static final Block block = null;

	public ReinforcedpinkBlock(BydnahBlocksModElements instance) {
		super(instance, 268);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedpink");
		}
