...
public class HazardPurpleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:hazard_purple")
	public static final Block block = null;

	public HazardPurpleBlock(BydnahBlocksModElements instance) {
		super(instance, 88);
	}
