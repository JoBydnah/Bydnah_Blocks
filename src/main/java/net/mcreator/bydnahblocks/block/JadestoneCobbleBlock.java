...
public class JadestoneCobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_cobble")
	public static final Block block = null;

	public JadestoneCobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 58);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jadestone_cobble");
		}
