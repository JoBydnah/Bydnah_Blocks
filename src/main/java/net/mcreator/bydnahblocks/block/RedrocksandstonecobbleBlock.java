...
public class RedrocksandstonecobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonecobble")
	public static final Block block = null;

	public RedrocksandstonecobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 634);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonecobble");
		}
