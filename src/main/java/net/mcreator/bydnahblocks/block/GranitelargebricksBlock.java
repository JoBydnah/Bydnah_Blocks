...
public class GranitelargebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitelargebricks")
	public static final Block block = null;

	public GranitelargebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 341);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitelargebricks");
		}
