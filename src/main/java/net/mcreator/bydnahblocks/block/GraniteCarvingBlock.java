...
public class GraniteCarvingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granite_carving")
	public static final Block block = null;

	public GraniteCarvingBlock(BydnahBlocksModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("granite_carving");
		}
