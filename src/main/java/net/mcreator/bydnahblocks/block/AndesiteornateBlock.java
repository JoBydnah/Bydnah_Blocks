...
public class AndesiteornateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesiteornate")
	public static final Block block = null;

	public AndesiteornateBlock(BydnahBlocksModElements instance) {
		super(instance, 462);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesiteornate");
		}
