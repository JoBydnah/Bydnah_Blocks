...
public class JunglefancycrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:junglefancycrate")
	public static final Block block = null;

	public JunglefancycrateBlock(BydnahBlocksModElements instance) {
		super(instance, 263);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("junglefancycrate");
		}
