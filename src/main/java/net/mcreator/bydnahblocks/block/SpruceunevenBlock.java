...
public class SpruceunevenBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:spruceuneven")
	public static final Block block = null;

	public SpruceunevenBlock(BydnahBlocksModElements instance) {
		super(instance, 376);
	}
