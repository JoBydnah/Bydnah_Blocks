...
public class CopperboltedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:copperbolted")
	public static final Block block = null;

	public CopperboltedBlock(BydnahBlocksModElements instance) {
		super(instance, 169);
	}
