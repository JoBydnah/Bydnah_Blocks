...
public class GranitemossycobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitemossycobble")
	public static final Block block = null;

	public GranitemossycobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 405);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitemossycobble");
		}
