...
public class SandstonetileslargeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonetileslarge")
	public static final Block block = null;

	public SandstonetileslargeBlock(BydnahBlocksModElements instance) {
		super(instance, 506);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonetileslarge");
		}
