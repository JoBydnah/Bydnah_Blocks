...
public class AridsandstonecarvingbetaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonecarvingbeta")
	public static final Block block = null;

	public AridsandstonecarvingbetaBlock(BydnahBlocksModElements instance) {
		super(instance, 573);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonecarvingbeta");
		}
