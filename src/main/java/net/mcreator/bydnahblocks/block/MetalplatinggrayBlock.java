...
public class MetalplatinggrayBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatinggray")
	public static final Block block = null;

	public MetalplatinggrayBlock(BydnahBlocksModElements instance) {
		super(instance, 245);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatinggray");
		}
