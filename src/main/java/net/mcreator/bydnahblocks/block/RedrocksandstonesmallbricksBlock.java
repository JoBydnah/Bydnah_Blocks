...
public class RedrocksandstonesmallbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonesmallbricks")
	public static final Block block = null;

	public RedrocksandstonesmallbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 647);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonesmallbricks");
		}
