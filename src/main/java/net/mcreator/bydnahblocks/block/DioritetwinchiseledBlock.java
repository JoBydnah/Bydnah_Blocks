...
public class DioritetwinchiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritetwinchiseled")
	public static final Block block = null;

	public DioritetwinchiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 483);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioritetwinchiseled");
		}
