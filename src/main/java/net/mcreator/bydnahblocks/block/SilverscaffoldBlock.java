...
public class SilverscaffoldBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:silverscaffold")
	public static final Block block = null;

	public SilverscaffoldBlock(BydnahBlocksModElements instance) {
		super(instance, 130);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("silverscaffold");
		}
