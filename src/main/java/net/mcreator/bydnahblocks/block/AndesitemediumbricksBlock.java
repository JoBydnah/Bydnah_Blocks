...
public class AndesitemediumbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitemediumbricks")
	public static final Block block = null;

	public AndesitemediumbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 357);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitemediumbricks");
		}
