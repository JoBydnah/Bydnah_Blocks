...
public class DioritelargebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritelargebricks")
	public static final Block block = null;

	public DioritelargebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 346);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioritelargebricks");
		}
