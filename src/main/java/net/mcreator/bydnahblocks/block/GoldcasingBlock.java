...
public class GoldcasingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:goldcasing")
	public static final Block block = null;

	public GoldcasingBlock(BydnahBlocksModElements instance) {
		super(instance, 96);
	}
