...
public class DarkoakcleanBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:darkoakclean")
	public static final Block block = null;

	public DarkoakcleanBlock(BydnahBlocksModElements instance) {
		super(instance, 328);
	}
