...
public class CobaltencasedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:cobaltencased")
	public static final Block block = null;

	public CobaltencasedBlock(BydnahBlocksModElements instance) {
		super(instance, 104);
	}
