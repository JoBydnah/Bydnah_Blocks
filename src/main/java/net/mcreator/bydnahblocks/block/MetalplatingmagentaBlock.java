...
public class MetalplatingmagentaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatingmagenta")
	public static final Block block = null;

	public MetalplatingmagentaBlock(BydnahBlocksModElements instance) {
		super(instance, 169);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatingmagenta");
		}
