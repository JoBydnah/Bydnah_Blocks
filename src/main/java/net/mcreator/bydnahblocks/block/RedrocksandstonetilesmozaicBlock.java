...
public class RedrocksandstonetilesmozaicBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonetilesmozaic")
	public static final Block block = null;

	public RedrocksandstonetilesmozaicBlock(BydnahBlocksModElements instance) {
		super(instance, 651);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonetilesmozaic");
		}
