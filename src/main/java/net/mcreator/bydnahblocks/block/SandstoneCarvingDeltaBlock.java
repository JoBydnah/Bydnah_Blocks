...
public class SandstoneCarvingDeltaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstone_carving_delta")
	public static final Block block = null;

	public SandstoneCarvingDeltaBlock(BydnahBlocksModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstone_carving_delta");
		}
