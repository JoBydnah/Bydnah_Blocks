...
public class HazardRedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:hazard_red")
	public static final Block block = null;

	public HazardRedBlock(BydnahBlocksModElements instance) {
		super(instance, 39);
	}
