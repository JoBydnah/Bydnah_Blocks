...
public class Steeldoor4Block extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:steeldoor_4")
	public static final Block block = null;

	public Steeldoor4Block(BydnahBlocksModElements instance) {
		super(instance, 318);
	}
