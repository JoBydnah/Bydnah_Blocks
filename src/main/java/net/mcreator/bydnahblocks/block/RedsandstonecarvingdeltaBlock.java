...
public class RedsandstonecarvingdeltaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redsandstonecarvingdelta")
	public static final Block block = null;

	public RedsandstonecarvingdeltaBlock(BydnahBlocksModElements instance) {
		super(instance, 111);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redsandstonecarvingdelta");
		}
