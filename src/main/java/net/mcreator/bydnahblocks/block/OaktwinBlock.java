...
public class OaktwinBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:oaktwin")
	public static final Block block = null;

	public OaktwinBlock(BydnahBlocksModElements instance) {
		super(instance, 281);
	}
