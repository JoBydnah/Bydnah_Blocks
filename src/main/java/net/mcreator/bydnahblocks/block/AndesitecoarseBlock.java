...
public class AndesitecoarseBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitecoarse")
	public static final Block block = null;

	public AndesitecoarseBlock(BydnahBlocksModElements instance) {
		super(instance, 350);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitecoarse");
		}
