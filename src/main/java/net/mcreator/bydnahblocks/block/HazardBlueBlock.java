...
public class HazardBlueBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:hazard_blue")
	public static final Block block = null;

	public HazardBlueBlock(BydnahBlocksModElements instance) {
		super(instance, 86);
	}
