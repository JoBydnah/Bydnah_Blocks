...
public class JadestoneBricksMossyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_bricks_mossy")
	public static final Block block = null;

	public JadestoneBricksMossyBlock(BydnahBlocksModElements instance) {
		super(instance, 129);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jadestone_bricks_mossy");
		}
