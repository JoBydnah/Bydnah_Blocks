...
public class RedsandstonecarvingbetaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redsandstonecarvingbeta")
	public static final Block block = null;

	public RedsandstonecarvingbetaBlock(BydnahBlocksModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redsandstonecarvingbeta");
		}
