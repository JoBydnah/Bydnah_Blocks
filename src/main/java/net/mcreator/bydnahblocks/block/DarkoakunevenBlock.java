...
public class DarkoakunevenBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:darkoakuneven")
	public static final Block block = null;

	public DarkoakunevenBlock(BydnahBlocksModElements instance) {
		super(instance, 256);
	}
