...
public class BirchfancyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:birchfancy")
	public static final Block block = null;

	public BirchfancyBlock(BydnahBlocksModElements instance) {
		super(instance, 224);
	}
