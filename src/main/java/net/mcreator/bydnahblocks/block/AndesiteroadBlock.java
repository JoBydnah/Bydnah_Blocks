...
public class AndesiteroadBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesiteroad")
	public static final Block block = null;

	public AndesiteroadBlock(BydnahBlocksModElements instance) {
		super(instance, 456);
	}
