...
public class ReinforcedplatingwhiteBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatingwhite")
	public static final Block block = null;

	public ReinforcedplatingwhiteBlock(BydnahBlocksModElements instance) {
		super(instance, 206);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatingwhite");
		}
