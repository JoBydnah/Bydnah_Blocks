...
public class MarblemossycobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblemossycobble")
	public static final Block block = null;

	public MarblemossycobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 406);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marblemossycobble");
		}
