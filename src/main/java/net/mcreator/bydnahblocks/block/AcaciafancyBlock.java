...
public class AcaciafancyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:acaciafancy")
	public static final Block block = null;

	public AcaciafancyBlock(BydnahBlocksModElements instance) {
		super(instance, 211);
	}
