...
public class AridsandstonelargebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonelargebricks")
	public static final Block block = null;

	public AridsandstonelargebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 550);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonelargebricks");
		}
