...
public class SandstonetwinchiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonetwinchiseled")
	public static final Block block = null;

	public SandstonetwinchiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 509);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonetwinchiseled");
		}
