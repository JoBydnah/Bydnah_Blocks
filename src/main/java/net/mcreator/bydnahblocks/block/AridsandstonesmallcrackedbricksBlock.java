...
public class AridsandstonesmallcrackedbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonesmallcrackedbricks")
	public static final Block block = null;

	public AridsandstonesmallcrackedbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 563);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonesmallcrackedbricks");
		}
