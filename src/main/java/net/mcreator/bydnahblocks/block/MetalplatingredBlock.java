...
public class MetalplatingredBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatingred")
	public static final Block block = null;

	public MetalplatingredBlock(BydnahBlocksModElements instance) {
		super(instance, 254);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatingred");
		}
