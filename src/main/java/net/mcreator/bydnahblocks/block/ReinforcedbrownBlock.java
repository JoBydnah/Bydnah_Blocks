...
public class ReinforcedbrownBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedbrown")
	public static final Block block = null;

	public ReinforcedbrownBlock(BydnahBlocksModElements instance) {
		super(instance, 259);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedbrown");
		}
