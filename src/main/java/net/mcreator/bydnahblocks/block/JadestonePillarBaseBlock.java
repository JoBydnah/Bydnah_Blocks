...
public class JadestonePillarBaseBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_pillar_base")
	public static final Block block = null;

	public JadestonePillarBaseBlock(BydnahBlocksModElements instance) {
		super(instance, 760);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("jadestone_pillar_base");
		}
