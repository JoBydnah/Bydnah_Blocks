...
public class RedrocksandstoneprismBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstoneprism")
	public static final Block block = null;

	public RedrocksandstoneprismBlock(BydnahBlocksModElements instance) {
		super(instance, 644);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstoneprism");
		}
