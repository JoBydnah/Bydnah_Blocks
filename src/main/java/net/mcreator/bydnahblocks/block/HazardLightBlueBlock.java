...
public class HazardLightBlueBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:hazard_light_blue")
	public static final Block block = null;

	public HazardLightBlueBlock(BydnahBlocksModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hazard_light_blue");
		}
