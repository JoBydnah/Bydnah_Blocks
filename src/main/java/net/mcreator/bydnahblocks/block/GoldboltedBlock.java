...
public class GoldboltedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:goldbolted")
	public static final Block block = null;

	public GoldboltedBlock(BydnahBlocksModElements instance) {
		super(instance, 175);
	}
