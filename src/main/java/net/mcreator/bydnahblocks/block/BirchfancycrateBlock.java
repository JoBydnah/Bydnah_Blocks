...
public class BirchfancycrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:birchfancycrate")
	public static final Block block = null;

	public BirchfancycrateBlock(BydnahBlocksModElements instance) {
		super(instance, 306);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("birchfancycrate");
		}
