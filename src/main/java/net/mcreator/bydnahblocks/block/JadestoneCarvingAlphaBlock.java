...
public class JadestoneCarvingAlphaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_carving_alpha")
	public static final Block block = null;

	public JadestoneCarvingAlphaBlock(BydnahBlocksModElements instance) {
		super(instance, 132);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jadestone_carving_alpha");
		}
