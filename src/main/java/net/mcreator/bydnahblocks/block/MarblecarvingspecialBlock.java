...
public class MarblecarvingspecialBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblecarvingspecial")
	public static final Block block = null;

	public MarblecarvingspecialBlock(BydnahBlocksModElements instance) {
		super(instance, 320);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marblecarvingspecial");
		}
