...
public class DioritemossycobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritemossycobble")
	public static final Block block = null;

	public DioritemossycobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 403);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioritemossycobble");
		}
