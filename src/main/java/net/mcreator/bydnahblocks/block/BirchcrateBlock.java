...
public class BirchcrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:birchcrate")
	public static final Block block = null;

	public BirchcrateBlock(BydnahBlocksModElements instance) {
		super(instance, 222);
	}
