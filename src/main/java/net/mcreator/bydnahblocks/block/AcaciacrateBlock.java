...
public class AcaciacrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:acaciacrate")
	public static final Block block = null;

	public AcaciacrateBlock(BydnahBlocksModElements instance) {
		super(instance, 293);
	}
