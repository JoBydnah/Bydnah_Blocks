...
public class RedrocksandstoneroadBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstoneroad")
	public static final Block block = null;

	public RedrocksandstoneroadBlock(BydnahBlocksModElements instance) {
		super(instance, 645);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstoneroad");
		}
