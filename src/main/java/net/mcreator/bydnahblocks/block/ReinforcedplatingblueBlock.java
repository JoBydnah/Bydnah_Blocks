...
public class ReinforcedplatingblueBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatingblue")
	public static final Block block = null;

	public ReinforcedplatingblueBlock(BydnahBlocksModElements instance) {
		super(instance, 193);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatingblue");
		}
