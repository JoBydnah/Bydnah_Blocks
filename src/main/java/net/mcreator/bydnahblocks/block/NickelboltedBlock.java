...
public class NickelboltedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:nickelbolted")
	public static final Block block = null;

	public NickelboltedBlock(BydnahBlocksModElements instance) {
		super(instance, 212);
	}
