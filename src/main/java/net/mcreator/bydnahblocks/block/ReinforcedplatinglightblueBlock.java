...
public class ReinforcedplatinglightblueBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatinglightblue")
	public static final Block block = null;

	public ReinforcedplatinglightblueBlock(BydnahBlocksModElements instance) {
		super(instance, 279);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatinglightblue");
		}
