...
public class AndesitetileslargeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitetileslarge")
	public static final Block block = null;

	public AndesitetileslargeBlock(BydnahBlocksModElements instance) {
		super(instance, 465);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitetileslarge");
		}
