...
public class SpruceparquetBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:spruceparquet")
	public static final Block block = null;

	public SpruceparquetBlock(BydnahBlocksModElements instance) {
		super(instance, 291);
	}
