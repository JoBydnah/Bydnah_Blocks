...
public class RedrocksandstonetwinlargechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonetwinlargechiseled")
	public static final Block block = null;

	public RedrocksandstonetwinlargechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 654);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonetwinlargechiseled");
		}
