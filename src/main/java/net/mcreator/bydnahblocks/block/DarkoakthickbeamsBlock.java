...
public class DarkoakthickbeamsBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:darkoakthickbeams")
	public static final Block block = null;

	public DarkoakthickbeamsBlock(BydnahBlocksModElements instance) {
		super(instance, 254);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("darkoakthickbeams");
		}
