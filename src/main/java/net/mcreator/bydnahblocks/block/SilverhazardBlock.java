...
public class SilverhazardBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:silverhazard")
	public static final Block block = null;

	public SilverhazardBlock(BydnahBlocksModElements instance) {
		super(instance, 129);
	}
