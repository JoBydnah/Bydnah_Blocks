...
public class SlatefancyblankBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatefancyblank")
	public static final Block block = null;

	public SlatefancyblankBlock(BydnahBlocksModElements instance) {
		super(instance, 583);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slatefancyblank");
		}
