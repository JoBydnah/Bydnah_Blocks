...
public class SteelWallBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:steel_wall")
	public static final Block block = null;

	public SteelWallBlock(BydnahBlocksModElements instance) {
		super(instance, 298);
	}
