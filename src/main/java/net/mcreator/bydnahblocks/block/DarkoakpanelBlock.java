...
public class DarkoakpanelBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:darkoakpanel")
	public static final Block block = null;

	public DarkoakpanelBlock(BydnahBlocksModElements instance) {
		super(instance, 252);
	}
