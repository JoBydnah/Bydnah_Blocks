...
public class JadestoneCarvingGammaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_carving_gamma")
	public static final Block block = null;

	public JadestoneCarvingGammaBlock(BydnahBlocksModElements instance) {
		super(instance, 134);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jadestone_carving_gamma");
		}
