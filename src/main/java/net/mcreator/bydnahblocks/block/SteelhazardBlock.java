...
public class SteelhazardBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:steelhazard")
	public static final Block block = null;

	public SteelhazardBlock(BydnahBlocksModElements instance) {
		super(instance, 111);
	}
