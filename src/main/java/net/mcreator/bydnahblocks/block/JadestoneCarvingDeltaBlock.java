...
public class JadestoneCarvingDeltaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_carving_delta")
	public static final Block block = null;

	public JadestoneCarvingDeltaBlock(BydnahBlocksModElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jadestone_carving_delta");
		}
