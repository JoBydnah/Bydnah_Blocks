...
public class AridsandstoneprismBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstoneprism")
	public static final Block block = null;

	public AridsandstoneprismBlock(BydnahBlocksModElements instance) {
		super(instance, 559);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstoneprism");
		}
