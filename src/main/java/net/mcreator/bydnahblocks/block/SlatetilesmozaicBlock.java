...
public class SlatetilesmozaicBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatetilesmozaic")
	public static final Block block = null;

	public SlatetilesmozaicBlock(BydnahBlocksModElements instance) {
		super(instance, 597);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slatetilesmozaic");
		}
