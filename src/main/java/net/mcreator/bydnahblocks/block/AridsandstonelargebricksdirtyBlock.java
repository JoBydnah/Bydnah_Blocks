...
public class AridsandstonelargebricksdirtyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonelargebricksdirty")
	public static final Block block = null;

	public AridsandstonelargebricksdirtyBlock(BydnahBlocksModElements instance) {
		super(instance, 551);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonelargebricksdirty");
		}
