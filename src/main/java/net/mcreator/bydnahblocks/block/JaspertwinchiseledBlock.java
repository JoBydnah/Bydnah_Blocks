...
public class JaspertwinchiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jaspertwinchiseled")
	public static final Block block = null;

	public JaspertwinchiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 625);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jaspertwinchiseled");
		}
