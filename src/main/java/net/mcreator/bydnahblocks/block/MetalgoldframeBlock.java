...
public class MetalgoldframeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalgoldframe")
	public static final Block block = null;

	public MetalgoldframeBlock(BydnahBlocksModElements instance) {
		super(instance, 81);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalgoldframe");
		}
