...
public class CopperhazardBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:copperhazard")
	public static final Block block = null;

	public CopperhazardBlock(BydnahBlocksModElements instance) {
		super(instance, 93);
	}
