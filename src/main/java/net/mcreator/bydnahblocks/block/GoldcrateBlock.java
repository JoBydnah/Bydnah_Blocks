...
public class GoldcrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:goldcrate")
	public static final Block block = null;

	public GoldcrateBlock(BydnahBlocksModElements instance) {
		super(instance, 177);
	}
