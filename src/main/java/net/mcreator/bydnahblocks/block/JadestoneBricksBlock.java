...
public class JadestoneBricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_bricks")
	public static final Block block = null;

	public JadestoneBricksBlock(BydnahBlocksModElements instance) {
		super(instance, 128);
	}
