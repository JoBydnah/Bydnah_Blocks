...
public class AridsandstoneornateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstoneornate")
	public static final Block block = null;

	public AridsandstoneornateBlock(BydnahBlocksModElements instance) {
		super(instance, 554);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstoneornate");
		}
