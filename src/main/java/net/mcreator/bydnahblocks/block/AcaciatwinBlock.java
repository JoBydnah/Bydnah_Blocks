...
public class AcaciatwinBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:acaciatwin")
	public static final Block block = null;

	public AcaciatwinBlock(BydnahBlocksModElements instance) {
		super(instance, 296);
	}
