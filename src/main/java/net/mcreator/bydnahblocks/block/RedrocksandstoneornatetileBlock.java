...
public class RedrocksandstoneornatetileBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstoneornatetile")
	public static final Block block = null;

	public RedrocksandstoneornatetileBlock(BydnahBlocksModElements instance) {
		super(instance, 640);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstoneornatetile");
		}
