...
public class AndesiteornatebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesiteornatebricks")
	public static final Block block = null;

	public AndesiteornatebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 463);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesiteornatebricks");
		}
