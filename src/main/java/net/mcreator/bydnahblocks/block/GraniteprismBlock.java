...
public class GraniteprismBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:graniteprism")
	public static final Block block = null;

	public GraniteprismBlock(BydnahBlocksModElements instance) {
		super(instance, 443);
	}
