...
public class MarblecoarseBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblecoarse")
	public static final Block block = null;

	public MarblecoarseBlock(BydnahBlocksModElements instance) {
		super(instance, 353);
	}
