...
public class DioriteinvertedtileBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioriteinvertedtile")
	public static final Block block = null;

	public DioriteinvertedtileBlock(BydnahBlocksModElements instance) {
		super(instance, 477);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioriteinvertedtile");
		}
