...
public class SandstonefancyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonefancy")
	public static final Block block = null;

	public SandstonefancyBlock(BydnahBlocksModElements instance) {
		super(instance, 493);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonefancy");
		}
