...
public class OakfancycrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:oakfancycrate")
	public static final Block block = null;

	public OakfancycrateBlock(BydnahBlocksModElements instance) {
		super(instance, 357);
	}
