...
public class JadedtulipgreenBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadedtulip_cyan")
	public static final Block block = null;

	public JadedtulipgreenBlock(BydnahBlocksModElements instance) {
		super(instance, 818);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("jadedtulip_cyan"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("bydnah_blocks:jadedtulip_cyan"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("jadedtulip_cyan");
		}
