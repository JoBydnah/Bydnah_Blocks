...
public class NickelscaffoldBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:nickelscaffold")
	public static final Block block = null;

	public NickelscaffoldBlock(BydnahBlocksModElements instance) {
		super(instance, 136);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("nickelscaffold");
		}
