...
public class BirchcratesBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:birchcrates")
	public static final Block block = null;

	public BirchcratesBlock(BydnahBlocksModElements instance) {
		super(instance, 223);
	}
