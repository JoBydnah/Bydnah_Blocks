...
public class JaspertwinlargechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jaspertwinlargechiseled")
	public static final Block block = null;

	public JaspertwinlargechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 626);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jaspertwinlargechiseled");
		}
