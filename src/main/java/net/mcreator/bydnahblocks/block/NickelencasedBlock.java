...
public class NickelencasedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:nickelencased")
	public static final Block block = null;

	public NickelencasedBlock(BydnahBlocksModElements instance) {
		super(instance, 134);
	}
