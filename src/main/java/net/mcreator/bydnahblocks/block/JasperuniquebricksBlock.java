...
public class JasperuniquebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jasperuniquebricks")
	public static final Block block = null;

	public JasperuniquebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 628);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jasperuniquebricks");
		}
