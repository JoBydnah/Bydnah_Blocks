...
public class GoldscaffoldBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:goldscaffold")
	public static final Block block = null;

	public GoldscaffoldBlock(BydnahBlocksModElements instance) {
		super(instance, 100);
	}
