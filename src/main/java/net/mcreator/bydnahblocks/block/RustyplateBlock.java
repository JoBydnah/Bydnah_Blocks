...
public class RustyplateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:rustyplate")
	public static final Block block = null;

	public RustyplateBlock(BydnahBlocksModElements instance) {
		super(instance, 155);
	}
