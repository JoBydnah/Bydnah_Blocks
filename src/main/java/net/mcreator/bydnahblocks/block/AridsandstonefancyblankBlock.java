...
public class AridsandstonefancyblankBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonefancyblank")
	public static final Block block = null;

	public AridsandstonefancyblankBlock(BydnahBlocksModElements instance) {
		super(instance, 549);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonefancyblank");
		}
