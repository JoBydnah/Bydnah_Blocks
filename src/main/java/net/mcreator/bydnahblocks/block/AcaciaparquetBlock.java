...
public class AcaciaparquetBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:acaciaparquet")
	public static final Block block = null;

	public AcaciaparquetBlock(BydnahBlocksModElements instance) {
		super(instance, 297);
	}
