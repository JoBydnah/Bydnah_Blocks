...
public class PrimordialLeavesBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:primordial_leaves")
	public static final Block block = null;

	public PrimordialLeavesBlock(BydnahBlocksModElements instance) {
		super(instance, 739);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("primordial_leaves");
		}
