...
public class AndesitecobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitecobble")
	public static final Block block = null;

	public AndesitecobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 437);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitecobble");
		}
