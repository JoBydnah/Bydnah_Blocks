...
public class RedrocksandstonepavementBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonepavement")
	public static final Block block = null;

	public RedrocksandstonepavementBlock(BydnahBlocksModElements instance) {
		super(instance, 643);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonepavement");
		}
