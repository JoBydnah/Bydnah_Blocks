...
public class CobaltcasingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:cobaltcasing")
	public static final Block block = null;

	public CobaltcasingBlock(BydnahBlocksModElements instance) {
		super(instance, 182);
	}
