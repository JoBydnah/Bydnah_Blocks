...
public class GranitesmallcrackedbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitesmallcrackedbricks")
	public static final Block block = null;

	public GranitesmallcrackedbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 342);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitesmallcrackedbricks");
		}
