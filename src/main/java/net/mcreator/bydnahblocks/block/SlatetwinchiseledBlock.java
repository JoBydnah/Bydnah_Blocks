...
public class SlatetwinchiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatetwinchiseled")
	public static final Block block = null;

	public SlatetwinchiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 599);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slatetwinchiseled");
		}
