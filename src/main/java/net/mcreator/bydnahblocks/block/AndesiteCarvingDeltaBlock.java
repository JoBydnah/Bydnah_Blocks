...
public class AndesiteCarvingDeltaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesite_carving_delta")
	public static final Block block = null;

	public AndesiteCarvingDeltaBlock(BydnahBlocksModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("andesite_carving_delta");
		}
