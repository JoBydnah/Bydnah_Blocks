...
public class IronencasedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:ironencased")
	public static final Block block = null;

	public IronencasedBlock(BydnahBlocksModElements instance) {
		super(instance, 167);
	}
