...
public class SlatecoarseBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatecoarse")
	public static final Block block = null;

	public SlatecoarseBlock(BydnahBlocksModElements instance) {
		super(instance, 580);
	}
