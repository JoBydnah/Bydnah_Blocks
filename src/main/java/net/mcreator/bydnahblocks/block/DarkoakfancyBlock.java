...
public class DarkoakfancyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:darkoakfancy")
	public static final Block block = null;

	public DarkoakfancyBlock(BydnahBlocksModElements instance) {
		super(instance, 250);
	}
