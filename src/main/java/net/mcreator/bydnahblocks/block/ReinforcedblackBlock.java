...
public class ReinforcedblackBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedblack")
	public static final Block block = null;

	public ReinforcedblackBlock(BydnahBlocksModElements instance) {
		super(instance, 176);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedblack");
		}
