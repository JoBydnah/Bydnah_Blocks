...
public class JunglewideplanksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:junglewideplanks")
	public static final Block block = null;

	public JunglewideplanksBlock(BydnahBlocksModElements instance) {
		super(instance, 270);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("junglewideplanks");
		}
