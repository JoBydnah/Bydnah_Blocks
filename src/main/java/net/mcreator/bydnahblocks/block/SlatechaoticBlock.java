...
public class SlatechaoticBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatechaotic")
	public static final Block block = null;

	public SlatechaoticBlock(BydnahBlocksModElements instance) {
		super(instance, 578);
	}
