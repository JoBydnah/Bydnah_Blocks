...
public class SandstoneCarvingBetaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstone_carving_beta")
	public static final Block block = null;

	public SandstoneCarvingBetaBlock(BydnahBlocksModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstone_carving_beta");
		}
