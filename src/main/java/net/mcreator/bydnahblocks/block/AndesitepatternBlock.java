...
public class AndesitepatternBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitepattern")
	public static final Block block = null;

	public AndesitepatternBlock(BydnahBlocksModElements instance) {
		super(instance, 464);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitepattern");
		}
