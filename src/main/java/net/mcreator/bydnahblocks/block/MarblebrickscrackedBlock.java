...
public class MarblebrickscrackedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblebrickscracked")
	public static final Block block = null;

	public MarblebrickscrackedBlock(BydnahBlocksModElements instance) {
		super(instance, 390);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marblebrickscracked");
		}
