...
public class BirchwideplanksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:birchwideplanks")
	public static final Block block = null;

	public BirchwideplanksBlock(BydnahBlocksModElements instance) {
		super(instance, 312);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("birchwideplanks");
		}
