...
public class ReinforcedplatinglightgrayBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatinglightgray")
	public static final Block block = null;

	public ReinforcedplatinglightgrayBlock(BydnahBlocksModElements instance) {
		super(instance, 199);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatinglightgray");
		}
