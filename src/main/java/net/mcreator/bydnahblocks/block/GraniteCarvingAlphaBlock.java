...
public class GraniteCarvingAlphaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granite_carving_alpha")
	public static final Block block = null;

	public GraniteCarvingAlphaBlock(BydnahBlocksModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("granite_carving_alpha");
		}
