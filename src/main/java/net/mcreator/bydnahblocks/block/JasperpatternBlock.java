...
public class JasperpatternBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jasperpattern")
	public static final Block block = null;

	public JasperpatternBlock(BydnahBlocksModElements instance) {
		super(instance, 615);
	}
