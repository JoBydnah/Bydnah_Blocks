...
public class AndesitetwinBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitetwin")
	public static final Block block = null;

	public AndesitetwinBlock(BydnahBlocksModElements instance) {
		super(instance, 468);
	}
