...
public class DioritepatternBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritepattern")
	public static final Block block = null;

	public DioritepatternBlock(BydnahBlocksModElements instance) {
		super(instance, 481);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioritepattern");
		}
