...
public class MarblefancyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblefancy")
	public static final Block block = null;

	public MarblefancyBlock(BydnahBlocksModElements instance) {
		super(instance, 403);
	}
