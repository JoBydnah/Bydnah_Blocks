...
public class AndesitechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitechiseled")
	public static final Block block = null;

	public AndesitechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 451);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitechiseled");
		}
