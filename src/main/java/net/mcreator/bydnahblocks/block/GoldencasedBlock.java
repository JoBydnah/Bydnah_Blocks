...
public class GoldencasedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:goldencased")
	public static final Block block = null;

	public GoldencasedBlock(BydnahBlocksModElements instance) {
		super(instance, 178);
	}
