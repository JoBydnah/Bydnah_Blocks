...
public class AndesitetwinchiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitetwinchiseled")
	public static final Block block = null;

	public AndesitetwinchiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 383);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitetwinchiseled");
		}
