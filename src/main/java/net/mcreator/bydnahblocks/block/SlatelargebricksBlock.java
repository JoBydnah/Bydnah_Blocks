...
public class SlatelargebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatelargebricks")
	public static final Block block = null;

	public SlatelargebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 584);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slatelargebricks");
		}
