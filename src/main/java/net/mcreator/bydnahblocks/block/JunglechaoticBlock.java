...
public class JunglechaoticBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:junglechaotic")
	public static final Block block = null;

	public JunglechaoticBlock(BydnahBlocksModElements instance) {
		super(instance, 258);
	}
