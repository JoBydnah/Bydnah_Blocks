...
public class UraniumencasedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:uraniumencased")
	public static final Block block = null;

	public UraniumencasedBlock(BydnahBlocksModElements instance) {
		super(instance, 122);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uraniumencased");
		}
