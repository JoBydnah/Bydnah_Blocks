...
public class UraniumhazardBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:uraniumhazard")
	public static final Block block = null;

	public UraniumhazardBlock(BydnahBlocksModElements instance) {
		super(instance, 123);
	}
