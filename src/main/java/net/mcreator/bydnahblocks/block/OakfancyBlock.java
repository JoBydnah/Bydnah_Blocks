...
public class OakfancyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:oakfancy")
	public static final Block block = null;

	public OakfancyBlock(BydnahBlocksModElements instance) {
		super(instance, 275);
	}
