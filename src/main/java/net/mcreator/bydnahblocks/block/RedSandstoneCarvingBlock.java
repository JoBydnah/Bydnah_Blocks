...
public class RedSandstoneCarvingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:red_sandstone_carving")
	public static final Block block = null;

	public RedSandstoneCarvingBlock(BydnahBlocksModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("red_sandstone_carving");
		}
