...
public class JunglecratesBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:junglecrates")
	public static final Block block = null;

	public JunglecratesBlock(BydnahBlocksModElements instance) {
		super(instance, 261);
	}
