...
public class GranitetilesmediumBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitetilesmedium")
	public static final Block block = null;

	public GranitetilesmediumBlock(BydnahBlocksModElements instance) {
		super(instance, 444);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitetilesmedium");
		}
