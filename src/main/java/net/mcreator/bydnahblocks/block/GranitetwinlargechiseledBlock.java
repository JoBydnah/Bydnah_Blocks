...
public class GranitetwinlargechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitetwinlargechiseled")
	public static final Block block = null;

	public GranitetwinlargechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 390);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitetwinlargechiseled");
		}
