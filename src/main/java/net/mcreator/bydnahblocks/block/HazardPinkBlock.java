...
public class HazardPinkBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:hazard_pink")
	public static final Block block = null;

	public HazardPinkBlock(BydnahBlocksModElements instance) {
		super(instance, 38);
	}
