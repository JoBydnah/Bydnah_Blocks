...
public class StonechaoticBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:stonechaotic")
	public static final Block block = null;

	public StonechaoticBlock(BydnahBlocksModElements instance) {
		super(instance, 537);
	}
