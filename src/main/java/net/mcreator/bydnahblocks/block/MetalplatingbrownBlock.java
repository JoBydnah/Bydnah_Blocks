...
public class MetalplatingbrownBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatingbrown")
	public static final Block block = null;

	public MetalplatingbrownBlock(BydnahBlocksModElements instance) {
		super(instance, 162);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatingbrown");
		}
