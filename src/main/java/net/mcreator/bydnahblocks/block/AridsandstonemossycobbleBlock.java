...
public class AridsandstonemossycobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonemossycobble")
	public static final Block block = null;

	public AridsandstonemossycobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 552);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonemossycobble");
		}
