...
public class GranitesmallbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitesmallbricks")
	public static final Block block = null;

	public GranitesmallbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 339);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitesmallbricks");
		}
