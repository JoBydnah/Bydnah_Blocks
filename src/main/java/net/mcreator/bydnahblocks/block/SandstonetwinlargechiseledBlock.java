...
public class SandstonetwinlargechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonetwinlargechiseled")
	public static final Block block = null;

	public SandstonetwinlargechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 512);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonetwinlargechiseled");
		}
