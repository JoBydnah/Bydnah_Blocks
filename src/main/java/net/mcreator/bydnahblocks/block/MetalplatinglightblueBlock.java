...
public class MetalplatinglightblueBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatinglightblue")
	public static final Block block = null;

	public MetalplatinglightblueBlock(BydnahBlocksModElements instance) {
		super(instance, 166);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatinglightblue");
		}
