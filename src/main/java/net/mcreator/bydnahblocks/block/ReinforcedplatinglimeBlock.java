...
public class ReinforcedplatinglimeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatinglime")
	public static final Block block = null;

	public ReinforcedplatinglimeBlock(BydnahBlocksModElements instance) {
		super(instance, 200);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatinglime");
		}
