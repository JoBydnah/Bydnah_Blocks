...
public class AndesiteCarvingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesite_carving")
	public static final Block block = null;

	public AndesiteCarvingBlock(BydnahBlocksModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("andesite_carving");
		}
