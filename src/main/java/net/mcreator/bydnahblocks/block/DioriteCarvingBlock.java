...
public class DioriteCarvingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:diorite_carving")
	public static final Block block = null;

	public DioriteCarvingBlock(BydnahBlocksModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("diorite_carving");
		}
