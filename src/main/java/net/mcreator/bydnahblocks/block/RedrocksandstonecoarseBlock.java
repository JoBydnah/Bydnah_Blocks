...
public class RedrocksandstonecoarseBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonecoarse")
	public static final Block block = null;

	public RedrocksandstonecoarseBlock(BydnahBlocksModElements instance) {
		super(instance, 633);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonecoarse");
		}
