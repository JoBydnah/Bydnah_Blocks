...
public class MetalplatingorangeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatingorange")
	public static final Block block = null;

	public MetalplatingorangeBlock(BydnahBlocksModElements instance) {
		super(instance, 251);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatingorange");
		}
