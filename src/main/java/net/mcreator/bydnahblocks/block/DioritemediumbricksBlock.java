...
public class DioritemediumbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritemediumbricks")
	public static final Block block = null;

	public DioritemediumbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 358);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioritemediumbricks");
		}
