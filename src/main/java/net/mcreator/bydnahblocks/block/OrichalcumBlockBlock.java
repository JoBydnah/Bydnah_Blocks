...
public class OrichalcumBlockBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:orichalcum_block")
	public static final Block block = null;

	public OrichalcumBlockBlock(BydnahBlocksModElements instance) {
		super(instance, 685);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orichalcum_block");
		}
