...
public class DioriteornatetileBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioriteornatetile")
	public static final Block block = null;

	public DioriteornatetileBlock(BydnahBlocksModElements instance) {
		super(instance, 396);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioriteornatetile");
		}
