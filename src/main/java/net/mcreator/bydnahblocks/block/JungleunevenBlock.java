...
public class JungleunevenBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jungleuneven")
	public static final Block block = null;

	public JungleunevenBlock(BydnahBlocksModElements instance) {
		super(instance, 269);
	}
