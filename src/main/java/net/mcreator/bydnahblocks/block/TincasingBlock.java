...
public class TincasingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:tincasing")
	public static final Block block = null;

	public TincasingBlock(BydnahBlocksModElements instance) {
		super(instance, 114);
	}
