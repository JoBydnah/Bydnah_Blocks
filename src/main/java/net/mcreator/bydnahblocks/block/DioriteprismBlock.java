...
public class DioriteprismBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioriteprism")
	public static final Block block = null;

	public DioriteprismBlock(BydnahBlocksModElements instance) {
		super(instance, 459);
	}
