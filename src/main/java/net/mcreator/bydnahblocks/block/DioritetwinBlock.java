...
public class DioritetwinBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritetwin")
	public static final Block block = null;

	public DioritetwinBlock(BydnahBlocksModElements instance) {
		super(instance, 485);
	}
