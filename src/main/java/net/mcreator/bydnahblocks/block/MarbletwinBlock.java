...
public class MarbletwinBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marbletwin")
	public static final Block block = null;

	public MarbletwinBlock(BydnahBlocksModElements instance) {
		super(instance, 329);
	}
