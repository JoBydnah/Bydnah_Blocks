...
public class PlatinumscaffoldBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:platinumscaffold")
	public static final Block block = null;

	public PlatinumscaffoldBlock(BydnahBlocksModElements instance) {
		super(instance, 223);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("platinumscaffold");
		}
