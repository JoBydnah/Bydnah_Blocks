...
public class JaspertilessmallBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jaspertilessmall")
	public static final Block block = null;

	public JaspertilessmallBlock(BydnahBlocksModElements instance) {
		super(instance, 624);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jaspertilessmall");
		}
