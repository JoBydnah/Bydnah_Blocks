...
public class AndesitesmallcrackedbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitesmallcrackedbricks")
	public static final Block block = null;

	public AndesitesmallcrackedbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 427);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitesmallcrackedbricks");
		}
