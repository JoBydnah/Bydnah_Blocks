...
public class MetalplatingyellowBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatingyellow")
	public static final Block block = null;

	public MetalplatingyellowBlock(BydnahBlocksModElements instance) {
		super(instance, 175);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatingyellow");
		}
