...
public class MetalplatingcyanBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatingcyan")
	public static final Block block = null;

	public MetalplatingcyanBlock(BydnahBlocksModElements instance) {
		super(instance, 244);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatingcyan");
		}
