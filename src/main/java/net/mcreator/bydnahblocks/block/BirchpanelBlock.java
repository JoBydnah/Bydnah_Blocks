...
public class BirchpanelBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:birchpanel")
	public static final Block block = null;

	public BirchpanelBlock(BydnahBlocksModElements instance) {
		super(instance, 226);
	}
