...
public class AridsandstonepanelBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonepanel")
	public static final Block block = null;

	public AridsandstonepanelBlock(BydnahBlocksModElements instance) {
		super(instance, 556);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonepanel");
		}
