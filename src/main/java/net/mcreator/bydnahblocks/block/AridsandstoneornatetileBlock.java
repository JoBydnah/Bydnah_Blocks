...
public class AridsandstoneornatetileBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstoneornatetile")
	public static final Block block = null;

	public AridsandstoneornatetileBlock(BydnahBlocksModElements instance) {
		super(instance, 555);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstoneornatetile");
		}
