...
public class OakcratesBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:oakcrates")
	public static final Block block = null;

	public OakcratesBlock(BydnahBlocksModElements instance) {
		super(instance, 355);
	}
