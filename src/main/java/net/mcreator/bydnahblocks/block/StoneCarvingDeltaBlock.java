...
public class StoneCarvingDeltaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:stone_carving_delta")
	public static final Block block = null;

	public StoneCarvingDeltaBlock(BydnahBlocksModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stone_carving_delta");
		}
