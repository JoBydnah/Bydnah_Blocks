...
public class PrimordialFenceBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:primordial_fence")
	public static final Block block = null;

	public PrimordialFenceBlock(BydnahBlocksModElements instance) {
		super(instance, 742);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("primordial_fence");
		}
