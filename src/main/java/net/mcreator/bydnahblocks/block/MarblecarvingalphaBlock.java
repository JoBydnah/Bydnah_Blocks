...
public class MarblecarvingalphaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblecarvingalpha")
	public static final Block block = null;

	public MarblecarvingalphaBlock(BydnahBlocksModElements instance) {
		super(instance, 316);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marblecarvingalpha");
		}
