...
public class DioriteroadBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioriteroad")
	public static final Block block = null;

	public DioriteroadBlock(BydnahBlocksModElements instance) {
		super(instance, 399);
	}
