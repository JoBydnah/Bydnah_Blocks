...
public class DioriteCarvingBetaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:diorite_carving_beta")
	public static final Block block = null;

	public DioriteCarvingBetaBlock(BydnahBlocksModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("diorite_carving_beta");
		}
