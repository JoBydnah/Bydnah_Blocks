...
public class MetalplatingpinkBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatingpink")
	public static final Block block = null;

	public MetalplatingpinkBlock(BydnahBlocksModElements instance) {
		super(instance, 252);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatingpink");
		}
