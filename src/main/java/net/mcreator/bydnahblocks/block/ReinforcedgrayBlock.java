...
public class ReinforcedgrayBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedgray")
	public static final Block block = null;

	public ReinforcedgrayBlock(BydnahBlocksModElements instance) {
		super(instance, 180);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedgray");
		}
