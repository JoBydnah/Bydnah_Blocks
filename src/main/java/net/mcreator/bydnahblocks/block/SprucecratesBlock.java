...
public class SprucecratesBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sprucecrates")
	public static final Block block = null;

	public SprucecratesBlock(BydnahBlocksModElements instance) {
		super(instance, 368);
	}
