...
public class RedrocksandstonetileslargeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonetileslarge")
	public static final Block block = null;

	public RedrocksandstonetileslargeBlock(BydnahBlocksModElements instance) {
		super(instance, 649);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonetileslarge");
		}
