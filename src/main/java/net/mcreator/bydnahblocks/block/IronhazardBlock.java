...
public class IronhazardBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:ironhazard")
	public static final Block block = null;

	public IronhazardBlock(BydnahBlocksModElements instance) {
		super(instance, 163);
	}
