...
public class RedrocksandstonepanelBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonepanel")
	public static final Block block = null;

	public RedrocksandstonepanelBlock(BydnahBlocksModElements instance) {
		super(instance, 641);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonepanel");
		}
