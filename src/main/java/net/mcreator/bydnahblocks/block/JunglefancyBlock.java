...
public class JunglefancyBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:junglefancy")
	public static final Block block = null;

	public JunglefancyBlock(BydnahBlocksModElements instance) {
		super(instance, 343);
	}
