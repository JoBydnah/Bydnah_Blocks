...
public class MarblebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblebricks")
	public static final Block block = null;

	public MarblebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 389);
	}
