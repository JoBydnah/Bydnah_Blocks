...
public class ReinforcedplatingpinkBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatingpink")
	public static final Block block = null;

	public ReinforcedplatingpinkBlock(BydnahBlocksModElements instance) {
		super(instance, 284);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatingpink");
		}
