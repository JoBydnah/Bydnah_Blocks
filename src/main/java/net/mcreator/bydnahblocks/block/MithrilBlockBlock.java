...
public class MithrilBlockBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:mithril_block")
	public static final Block block = null;

	public MithrilBlockBlock(BydnahBlocksModElements instance) {
		super(instance, 664);
	}
