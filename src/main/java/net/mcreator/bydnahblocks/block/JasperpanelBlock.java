...
public class JasperpanelBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jasperpanel")
	public static final Block block = null;

	public JasperpanelBlock(BydnahBlocksModElements instance) {
		super(instance, 614);
	}
