...
public class DioritechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritechiseled")
	public static final Block block = null;

	public DioritechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 458);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioritechiseled");
		}
