...
public class SlatesmallcrackedbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatesmallcrackedbricks")
	public static final Block block = null;

	public SlatesmallcrackedbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 594);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slatesmallcrackedbricks");
		}
