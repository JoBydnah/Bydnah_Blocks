...
public class MarbletileslargeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marbletileslarge")
	public static final Block block = null;

	public MarbletileslargeBlock(BydnahBlocksModElements instance) {
		super(instance, 405);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletileslarge");
		}
