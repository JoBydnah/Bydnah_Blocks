...
public class SteelcasingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:steelcasing")
	public static final Block block = null;

	public SteelcasingBlock(BydnahBlocksModElements instance) {
		super(instance, 108);
	}
