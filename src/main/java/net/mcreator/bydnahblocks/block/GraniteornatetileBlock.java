...
public class GraniteornatetileBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:graniteornatetile")
	public static final Block block = null;

	public GraniteornatetileBlock(BydnahBlocksModElements instance) {
		super(instance, 367);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("graniteornatetile");
		}
