...
public class SprucethickplanksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sprucethickplanks")
	public static final Block block = null;

	public SprucethickplanksBlock(BydnahBlocksModElements instance) {
		super(instance, 293);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sprucethickplanks");
		}
