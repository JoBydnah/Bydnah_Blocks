...
public class RedrocksandstonecarvingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonecarving")
	public static final Block block = null;

	public RedrocksandstonecarvingBlock(BydnahBlocksModElements instance) {
		super(instance, 630);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonecarving");
		}
