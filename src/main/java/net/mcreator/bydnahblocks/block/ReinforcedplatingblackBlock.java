...
public class ReinforcedplatingblackBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatingblack")
	public static final Block block = null;

	public ReinforcedplatingblackBlock(BydnahBlocksModElements instance) {
		super(instance, 192);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatingblack");
		}
