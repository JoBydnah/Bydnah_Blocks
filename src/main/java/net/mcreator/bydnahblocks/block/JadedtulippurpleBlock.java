...
public class JadedtulippurpleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadedtulippurple")
	public static final Block block = null;

	public JadedtulippurpleBlock(BydnahBlocksModElements instance) {
		super(instance, 820);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("jadedtulippurple"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("bydnah_blocks:jadedtulippurple"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("jadedtulippurple");
		}
