...
public class JunglepanelBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:junglepanel")
	public static final Block block = null;

	public JunglepanelBlock(BydnahBlocksModElements instance) {
		super(instance, 345);
	}
