...
public class SilvercrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:silvercrate")
	public static final Block block = null;

	public SilvercrateBlock(BydnahBlocksModElements instance) {
		super(instance, 208);
	}
