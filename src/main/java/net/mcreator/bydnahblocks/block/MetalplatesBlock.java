...
public class MetalplatesBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplates")
	public static final Block block = null;

	public MetalplatesBlock(BydnahBlocksModElements instance) {
		super(instance, 78);
	}
