...
public class RedrocksandstonelargebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonelargebricks")
	public static final Block block = null;

	public RedrocksandstonelargebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 637);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonelargebricks");
		}
