...
public class AridsandstonetilesmediumBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonetilesmedium")
	public static final Block block = null;

	public AridsandstonetilesmediumBlock(BydnahBlocksModElements instance) {
		super(instance, 565);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonetilesmedium");
		}
