...
public class AndesitesmallbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitesmallbricks")
	public static final Block block = null;

	public AndesitesmallbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 418);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitesmallbricks");
		}
