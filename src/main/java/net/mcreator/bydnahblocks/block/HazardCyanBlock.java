...
public class HazardCyanBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:hazard_cyan")
	public static final Block block = null;

	public HazardCyanBlock(BydnahBlocksModElements instance) {
		super(instance, 44);
	}
