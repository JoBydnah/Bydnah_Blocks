...
public class SprucecrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sprucecrate")
	public static final Block block = null;

	public SprucecrateBlock(BydnahBlocksModElements instance) {
		super(instance, 367);
	}
