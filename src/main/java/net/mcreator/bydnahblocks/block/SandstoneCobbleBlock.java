...
public class SandstoneCobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstone_cobble")
	public static final Block block = null;

	public SandstoneCobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 118);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstone_cobble");
		}
