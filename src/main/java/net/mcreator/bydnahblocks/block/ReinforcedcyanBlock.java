...
public class ReinforcedcyanBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedcyan")
	public static final Block block = null;

	public ReinforcedcyanBlock(BydnahBlocksModElements instance) {
		super(instance, 179);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedcyan");
		}
