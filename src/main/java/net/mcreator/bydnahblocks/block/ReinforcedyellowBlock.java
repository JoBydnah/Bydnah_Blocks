...
public class ReinforcedyellowBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedyellow")
	public static final Block block = null;

	public ReinforcedyellowBlock(BydnahBlocksModElements instance) {
		super(instance, 191);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedyellow");
		}
