...
public class GranitetilessmallBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitetilessmall")
	public static final Block block = null;

	public GranitetilessmallBlock(BydnahBlocksModElements instance) {
		super(instance, 362);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitetilessmall");
		}
