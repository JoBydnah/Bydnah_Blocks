...
public class MetalplatinglimeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatinglime")
	public static final Block block = null;

	public MetalplatinglimeBlock(BydnahBlocksModElements instance) {
		super(instance, 249);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatinglime");
		}
