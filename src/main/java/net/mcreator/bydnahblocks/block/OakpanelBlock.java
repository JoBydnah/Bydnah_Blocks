...
public class OakpanelBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:oakpanel")
	public static final Block block = null;

	public OakpanelBlock(BydnahBlocksModElements instance) {
		super(instance, 277);
	}
