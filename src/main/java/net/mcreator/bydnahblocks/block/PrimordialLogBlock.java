...
public class PrimordialLogBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:primordial_log")
	public static final Block block = null;

	public PrimordialLogBlock(BydnahBlocksModElements instance) {
		super(instance, 737);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("primordial_log");
		}
