...
public class SprucefancycrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sprucefancycrate")
	public static final Block block = null;

	public SprucefancycrateBlock(BydnahBlocksModElements instance) {
		super(instance, 289);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sprucefancycrate");
		}
