...
public class GranitecobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitecobble")
	public static final Block block = null;

	public GranitecobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 439);
	}
