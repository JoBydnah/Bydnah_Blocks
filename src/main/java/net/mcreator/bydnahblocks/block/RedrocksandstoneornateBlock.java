...
public class RedrocksandstoneornateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstoneornate")
	public static final Block block = null;

	public RedrocksandstoneornateBlock(BydnahBlocksModElements instance) {
		super(instance, 639);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstoneornate");
		}
