...
public class Steeldoor3Block extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:steeldoor_3")
	public static final Block block = null;

	public Steeldoor3Block(BydnahBlocksModElements instance) {
		super(instance, 317);
	}
