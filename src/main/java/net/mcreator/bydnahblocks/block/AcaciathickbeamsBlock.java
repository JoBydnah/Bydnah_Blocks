...
public class AcaciathickbeamsBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:acaciathickbeams")
	public static final Block block = null;

	public AcaciathickbeamsBlock(BydnahBlocksModElements instance) {
		super(instance, 289);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("acaciathickbeams");
		}
