...
public class RedrocksandstonechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redrocksandstonechiseled")
	public static final Block block = null;

	public RedrocksandstonechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 632);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redrocksandstonechiseled");
		}
