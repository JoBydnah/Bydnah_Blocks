...
public class SandstoneroadBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstoneroad")
	public static final Block block = null;

	public SandstoneroadBlock(BydnahBlocksModElements instance) {
		super(instance, 504);
	}
