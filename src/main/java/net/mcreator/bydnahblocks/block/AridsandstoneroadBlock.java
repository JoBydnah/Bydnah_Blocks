...
public class AridsandstoneroadBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstoneroad")
	public static final Block block = null;

	public AridsandstoneroadBlock(BydnahBlocksModElements instance) {
		super(instance, 560);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstoneroad");
		}
