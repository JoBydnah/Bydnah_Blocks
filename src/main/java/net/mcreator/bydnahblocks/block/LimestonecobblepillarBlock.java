...
public class LimestonecobblepillarBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:limestonecobblepillar")
	public static final Block block = null;

	public LimestonecobblepillarBlock(BydnahBlocksModElements instance) {
		super(instance, 797);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("limestonecobblepillar");
		}
		...
		public BlockState getStateForPlacement(BlockItemUseContext context) {
			...
			return this.getDefaultState().with(FACE, AttachFace.WALL).with(FACING, context.getFace());
		}
