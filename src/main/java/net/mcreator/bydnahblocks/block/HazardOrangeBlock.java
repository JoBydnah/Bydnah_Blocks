...
public class HazardOrangeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:hazard_orange")
	public static final Block block = null;

	public HazardOrangeBlock(BydnahBlocksModElements instance) {
		super(instance, 39);
	}
