...
public class MarbleornateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marbleornate")
	public static final Block block = null;

	public MarbleornateBlock(BydnahBlocksModElements instance) {
		super(instance, 323);
	}
