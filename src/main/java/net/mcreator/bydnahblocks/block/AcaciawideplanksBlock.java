...
public class AcaciawideplanksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:acaciawideplanks")
	public static final Block block = null;

	public AcaciawideplanksBlock(BydnahBlocksModElements instance) {
		super(instance, 299);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("acaciawideplanks");
		}
