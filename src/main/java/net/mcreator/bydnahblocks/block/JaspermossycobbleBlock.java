...
public class JaspermossycobbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jaspermossycobble")
	public static final Block block = null;

	public JaspermossycobbleBlock(BydnahBlocksModElements instance) {
		super(instance, 611);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jaspermossycobble");
		}
