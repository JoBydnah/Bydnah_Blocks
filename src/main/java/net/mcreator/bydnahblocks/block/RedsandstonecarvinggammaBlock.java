...
public class RedsandstonecarvinggammaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:redsandstonecarvinggamma")
	public static final Block block = null;

	public RedsandstonecarvinggammaBlock(BydnahBlocksModElements instance) {
		super(instance, 110);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redsandstonecarvinggamma");
		}
