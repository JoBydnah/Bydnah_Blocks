...
public class ReinforcedplatinggreenBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatinggreen")
	public static final Block block = null;

	public ReinforcedplatinggreenBlock(BydnahBlocksModElements instance) {
		super(instance, 278);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatinggreen");
		}
