...
public class JadestoneCobbleSlabBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_cobble_slab")
	public static final Block block = null;

	public JadestoneCobbleSlabBlock(BydnahBlocksModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("jadestone_cobble_slab");
		}
