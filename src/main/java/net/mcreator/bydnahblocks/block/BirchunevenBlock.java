...
public class BirchunevenBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:birchuneven")
	public static final Block block = null;

	public BirchunevenBlock(BydnahBlocksModElements instance) {
		super(instance, 311);
	}
