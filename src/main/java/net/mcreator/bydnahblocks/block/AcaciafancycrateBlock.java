...
public class AcaciafancycrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:acaciafancycrate")
	public static final Block block = null;

	public AcaciafancycrateBlock(BydnahBlocksModElements instance) {
		super(instance, 210);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("acaciafancycrate");
		}
