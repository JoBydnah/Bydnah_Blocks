...
public class GranitemediumbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitemediumbricks")
	public static final Block block = null;

	public GranitemediumbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 442);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitemediumbricks");
		}
