...
public class MarbletilessmallBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marbletilessmall")
	public static final Block block = null;

	public MarbletilessmallBlock(BydnahBlocksModElements instance) {
		super(instance, 407);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletilessmall");
		}
