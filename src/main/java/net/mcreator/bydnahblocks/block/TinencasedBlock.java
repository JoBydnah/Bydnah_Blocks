...
public class TinencasedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:tinencased")
	public static final Block block = null;

	public TinencasedBlock(BydnahBlocksModElements instance) {
		super(instance, 116);
	}
