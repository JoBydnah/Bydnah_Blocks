...
public class JadestoneCobbleStairsBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_cobble_stairs")
	public static final Block block = null;

	public JadestoneCobbleStairsBlock(BydnahBlocksModElements instance) {
		super(instance, 145);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("jadestone_cobble_stairs");
		}
