...
public class RustyDoor1Block extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:rusty_door_1")
	public static final Block block = null;

	public RustyDoor1Block(BydnahBlocksModElements instance) {
		super(instance, 300);
	}
