...
public class AridsandstonecarvingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonecarving")
	public static final Block block = null;

	public AridsandstonecarvingBlock(BydnahBlocksModElements instance) {
		super(instance, 571);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonecarving");
		}
