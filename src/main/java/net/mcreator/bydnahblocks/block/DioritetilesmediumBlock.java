...
public class DioritetilesmediumBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritetilesmedium")
	public static final Block block = null;

	public DioritetilesmediumBlock(BydnahBlocksModElements instance) {
		super(instance, 377);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioritetilesmedium");
		}
