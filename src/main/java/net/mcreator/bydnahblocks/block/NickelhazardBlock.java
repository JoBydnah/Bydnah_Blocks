...
public class NickelhazardBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:nickelhazard")
	public static final Block block = null;

	public NickelhazardBlock(BydnahBlocksModElements instance) {
		super(instance, 135);
	}
