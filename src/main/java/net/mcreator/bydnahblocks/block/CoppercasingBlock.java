...
public class CoppercasingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:coppercasing")
	public static final Block block = null;

	public CoppercasingBlock(BydnahBlocksModElements instance) {
		super(instance, 170);
	}
