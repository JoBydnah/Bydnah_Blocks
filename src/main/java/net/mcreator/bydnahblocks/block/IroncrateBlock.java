...
public class IroncrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:ironcrate")
	public static final Block block = null;

	public IroncrateBlock(BydnahBlocksModElements instance) {
		super(instance, 84);
	}
