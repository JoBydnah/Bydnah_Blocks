...
public class SprucewideplanksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sprucewideplanks")
	public static final Block block = null;

	public SprucewideplanksBlock(BydnahBlocksModElements instance) {
		super(instance, 377);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sprucewideplanks");
		}
