...
public class SilverencasedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:silverencased")
	public static final Block block = null;

	public SilverencasedBlock(BydnahBlocksModElements instance) {
		super(instance, 209);
	}
