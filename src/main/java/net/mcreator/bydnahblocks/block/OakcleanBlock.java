...
public class OakcleanBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:oakclean")
	public static final Block block = null;

	public OakcleanBlock(BydnahBlocksModElements instance) {
		super(instance, 272);
	}
