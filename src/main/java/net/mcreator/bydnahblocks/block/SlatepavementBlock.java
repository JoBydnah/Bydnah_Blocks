...
public class SlatepavementBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatepavement")
	public static final Block block = null;

	public SlatepavementBlock(BydnahBlocksModElements instance) {
		super(instance, 590);
	}
