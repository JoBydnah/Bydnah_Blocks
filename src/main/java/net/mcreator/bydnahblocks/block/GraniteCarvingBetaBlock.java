...
public class GraniteCarvingBetaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granite_carving_beta")
	public static final Block block = null;

	public GraniteCarvingBetaBlock(BydnahBlocksModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("granite_carving_beta");
		}
