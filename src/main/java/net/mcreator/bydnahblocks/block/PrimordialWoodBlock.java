...
public class PrimordialWoodBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:primordial_wood")
	public static final Block block = null;

	public PrimordialWoodBlock(BydnahBlocksModElements instance) {
		super(instance, 736);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("primordial_wood");
		}
