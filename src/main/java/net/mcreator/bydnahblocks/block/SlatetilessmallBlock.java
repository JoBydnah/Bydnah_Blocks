...
public class SlatetilessmallBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatetilessmall")
	public static final Block block = null;

	public SlatetilessmallBlock(BydnahBlocksModElements instance) {
		super(instance, 598);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slatetilessmall");
		}
