...
public class MetaltrapdoorBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metaltrapdoor")
	public static final Block block = null;

	public MetaltrapdoorBlock(BydnahBlocksModElements instance) {
		super(instance, 305);
	}
