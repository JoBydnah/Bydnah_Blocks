...
public class MarblecarvingbetaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblecarvingbeta")
	public static final Block block = null;

	public MarblecarvingbetaBlock(BydnahBlocksModElements instance) {
		super(instance, 398);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marblecarvingbeta");
		}
