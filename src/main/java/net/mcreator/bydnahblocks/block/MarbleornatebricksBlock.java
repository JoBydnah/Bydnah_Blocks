...
public class MarbleornatebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marbleornatebricks")
	public static final Block block = null;

	public MarbleornatebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 416);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbleornatebricks");
		}
