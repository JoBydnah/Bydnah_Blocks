...
public class GraniteornatebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:graniteornatebricks")
	public static final Block block = null;

	public GraniteornatebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 470);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("graniteornatebricks");
		}
