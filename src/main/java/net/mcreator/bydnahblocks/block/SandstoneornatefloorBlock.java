...
public class SandstoneornatefloorBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstoneornatefloor")
	public static final Block block = null;

	public SandstoneornatefloorBlock(BydnahBlocksModElements instance) {
		super(instance, 500);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstoneornatefloor");
		}
