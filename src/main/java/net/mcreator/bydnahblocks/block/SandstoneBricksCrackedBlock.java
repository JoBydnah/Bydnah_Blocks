...
public class SandstoneBricksCrackedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstone_bricks_cracked")
	public static final Block block = null;

	public SandstoneBricksCrackedBlock(BydnahBlocksModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstone_bricks_cracked");
		}
