...
public class SprucepanelBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sprucepanel")
	public static final Block block = null;

	public SprucepanelBlock(BydnahBlocksModElements instance) {
		super(instance, 371);
	}
