...
public class SandstonetwinsideBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonetwinside")
	public static final Block block = null;

	public SandstonetwinsideBlock(BydnahBlocksModElements instance) {
		super(instance, 510);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonetwinside");
		}
