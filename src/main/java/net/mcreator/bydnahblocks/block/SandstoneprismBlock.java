...
public class SandstoneprismBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstoneprism")
	public static final Block block = null;

	public SandstoneprismBlock(BydnahBlocksModElements instance) {
		super(instance, 513);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstoneprism");
		}
