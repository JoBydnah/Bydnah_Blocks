...
public class JungleshippingcrateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jungleshippingcrate")
	public static final Block block = null;

	public JungleshippingcrateBlock(BydnahBlocksModElements instance) {
		super(instance, 347);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("jungleshippingcrate");
		}
