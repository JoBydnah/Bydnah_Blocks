...
public class ReinforcedorangeBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedorange")
	public static final Block block = null;

	public ReinforcedorangeBlock(BydnahBlocksModElements instance) {
		super(instance, 186);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedorange");
		}
