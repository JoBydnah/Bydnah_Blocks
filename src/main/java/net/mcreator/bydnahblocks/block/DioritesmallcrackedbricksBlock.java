...
public class DioritesmallcrackedbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritesmallcrackedbricks")
	public static final Block block = null;

	public DioritesmallcrackedbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 347);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioritesmallcrackedbricks");
		}
