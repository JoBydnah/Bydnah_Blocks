...
public class ReinforcedplatingpurpleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:reinforcedplatingpurple")
	public static final Block block = null;

	public ReinforcedplatingpurpleBlock(BydnahBlocksModElements instance) {
		super(instance, 204);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reinforcedplatingpurple");
		}
