...
public class JadestoneStairsBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_stairs")
	public static final Block block = null;

	public JadestoneStairsBlock(BydnahBlocksModElements instance) {
		super(instance, 68);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("jadestone_stairs");
		}
