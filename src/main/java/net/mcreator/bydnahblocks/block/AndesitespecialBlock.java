...
public class AndesitespecialBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitespecial")
	public static final Block block = null;

	public AndesitespecialBlock(BydnahBlocksModElements instance) {
		super(instance, 370);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitespecial");
		}
