...
public class HazardMagentaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:hazard_magenta")
	public static final Block block = null;

	public HazardMagentaBlock(BydnahBlocksModElements instance) {
		super(instance, 80);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hazard_magenta");
		}
