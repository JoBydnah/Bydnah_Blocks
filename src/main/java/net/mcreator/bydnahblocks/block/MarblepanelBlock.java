...
public class MarblepanelBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marblepanel")
	public static final Block block = null;

	public MarblepanelBlock(BydnahBlocksModElements instance) {
		super(instance, 408);
	}
