...
public class JasperfancyblankBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jasperfancyblank")
	public static final Block block = null;

	public JasperfancyblankBlock(BydnahBlocksModElements instance) {
		super(instance, 609);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jasperfancyblank");
		}
