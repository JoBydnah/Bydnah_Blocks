...
public class JadestoneCarvingBetaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jadestone_carving_beta")
	public static final Block block = null;

	public JadestoneCarvingBetaBlock(BydnahBlocksModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jadestone_carving_beta");
		}
