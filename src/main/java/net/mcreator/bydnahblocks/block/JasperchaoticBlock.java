...
public class JasperchaoticBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jasperchaotic")
	public static final Block block = null;

	public JasperchaoticBlock(BydnahBlocksModElements instance) {
		super(instance, 604);
	}
