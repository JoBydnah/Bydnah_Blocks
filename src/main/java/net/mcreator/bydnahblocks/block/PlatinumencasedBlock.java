...
public class PlatinumencasedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:platinumencased")
	public static final Block block = null;

	public PlatinumencasedBlock(BydnahBlocksModElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("platinumencased");
		}
