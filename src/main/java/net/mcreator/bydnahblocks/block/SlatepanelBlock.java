...
public class SlatepanelBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatepanel")
	public static final Block block = null;

	public SlatepanelBlock(BydnahBlocksModElements instance) {
		super(instance, 588);
	}
