...
public class HazardWhiteBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:hazard_white")
	public static final Block block = null;

	public HazardWhiteBlock(BydnahBlocksModElements instance) {
		super(instance, 75);
	}
