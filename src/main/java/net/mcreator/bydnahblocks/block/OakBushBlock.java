...
public class OakBushBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:oak_bush")
	public static final Block block = null;

	public OakBushBlock(BydnahBlocksModElements instance) {
		super(instance, 106);
	}
