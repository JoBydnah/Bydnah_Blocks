...
public class RustysheetBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:rustysheet")
	public static final Block block = null;

	public RustysheetBlock(BydnahBlocksModElements instance) {
		super(instance, 159);
	}
