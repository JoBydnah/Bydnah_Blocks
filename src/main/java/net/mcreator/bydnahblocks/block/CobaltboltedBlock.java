...
public class CobaltboltedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:cobaltbolted")
	public static final Block block = null;

	public CobaltboltedBlock(BydnahBlocksModElements instance) {
		super(instance, 181);
	}
