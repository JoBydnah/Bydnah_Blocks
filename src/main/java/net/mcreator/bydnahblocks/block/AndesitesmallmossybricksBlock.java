...
public class AndesitesmallmossybricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitesmallmossybricks")
	public static final Block block = null;

	public AndesitesmallmossybricksBlock(BydnahBlocksModElements instance) {
		super(instance, 345);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitesmallmossybricks");
		}
