...
public class StoneCarvingBetaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:stone_carving_beta")
	public static final Block block = null;

	public StoneCarvingBetaBlock(BydnahBlocksModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stone_carving_beta");
		}
