...
public class DioritecoarseBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritecoarse")
	public static final Block block = null;

	public DioritecoarseBlock(BydnahBlocksModElements instance) {
		super(instance, 432);
	}
