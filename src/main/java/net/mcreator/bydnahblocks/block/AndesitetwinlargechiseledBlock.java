...
public class AndesitetwinlargechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:andesitetwinlargechiseled")
	public static final Block block = null;

	public AndesitetwinlargechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 384);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesitetwinlargechiseled");
		}
