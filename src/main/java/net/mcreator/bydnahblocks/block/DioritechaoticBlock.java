...
public class DioritechaoticBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritechaotic")
	public static final Block block = null;

	public DioritechaoticBlock(BydnahBlocksModElements instance) {
		super(instance, 535);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioritechaotic");
		}
