...
public class GraniteroadBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:graniteroad")
	public static final Block block = null;

	public GraniteroadBlock(BydnahBlocksModElements instance) {
		super(instance, 446);
	}
