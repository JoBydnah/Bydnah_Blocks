...
public class SprucechaoticBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sprucechaotic")
	public static final Block block = null;

	public SprucechaoticBlock(BydnahBlocksModElements instance) {
		super(instance, 284);
	}
