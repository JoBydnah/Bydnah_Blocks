...
public class SandstoneCarvingBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstone_carving")
	public static final Block block = null;

	public SandstoneCarvingBlock(BydnahBlocksModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstone_carving");
		}
