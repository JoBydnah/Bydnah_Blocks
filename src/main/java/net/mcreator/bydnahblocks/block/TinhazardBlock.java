...
public class TinhazardBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:tinhazard")
	public static final Block block = null;

	public TinhazardBlock(BydnahBlocksModElements instance) {
		super(instance, 197);
	}
