...
public class BirchchaoticBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:birchchaotic")
	public static final Block block = null;

	public BirchchaoticBlock(BydnahBlocksModElements instance) {
		super(instance, 301);
	}
