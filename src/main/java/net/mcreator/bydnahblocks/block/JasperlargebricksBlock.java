...
public class JasperlargebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jasperlargebricks")
	public static final Block block = null;

	public JasperlargebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 610);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jasperlargebricks");
		}
