...
public class CobaltscaffoldBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:cobaltscaffold")
	public static final Block block = null;

	public CobaltscaffoldBlock(BydnahBlocksModElements instance) {
		super(instance, 106);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobaltscaffold");
		}
