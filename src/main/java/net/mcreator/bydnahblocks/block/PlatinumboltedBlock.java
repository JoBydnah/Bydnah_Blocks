...
public class PlatinumboltedBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:platinumbolted")
	public static final Block block = null;

	public PlatinumboltedBlock(BydnahBlocksModElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("platinumbolted");
		}
