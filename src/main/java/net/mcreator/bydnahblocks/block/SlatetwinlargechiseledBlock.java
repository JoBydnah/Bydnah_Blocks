...
public class SlatetwinlargechiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatetwinlargechiseled")
	public static final Block block = null;

	public SlatetwinlargechiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 600);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slatetwinlargechiseled");
		}
