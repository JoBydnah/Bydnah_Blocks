...
public class MetalFrameBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metal_frame")
	public static final Block block = null;

	public MetalFrameBlock(BydnahBlocksModElements instance) {
		super(instance, 31);
	}
