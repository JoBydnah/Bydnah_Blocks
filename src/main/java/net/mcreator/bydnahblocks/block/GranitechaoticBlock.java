...
public class GranitechaoticBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitechaotic")
	public static final Block block = null;

	public GranitechaoticBlock(BydnahBlocksModElements instance) {
		super(instance, 536);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitechaotic");
		}
