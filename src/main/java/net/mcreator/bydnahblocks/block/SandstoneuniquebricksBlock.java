...
public class SandstoneuniquebricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstoneuniquebricks")
	public static final Block block = null;

	public SandstoneuniquebricksBlock(BydnahBlocksModElements instance) {
		super(instance, 511);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstoneuniquebricks");
		}
