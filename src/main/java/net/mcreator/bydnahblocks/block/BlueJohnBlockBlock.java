...
public class BlueJohnBlockBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:blue_john_block")
	public static final Block block = null;

	public BlueJohnBlockBlock(BydnahBlocksModElements instance) {
		super(instance, 70);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_john_block");
		}
