...
public class AridsandstonecarvingalphaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonecarvingalpha")
	public static final Block block = null;

	public AridsandstonecarvingalphaBlock(BydnahBlocksModElements instance) {
		super(instance, 572);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonecarvingalpha");
		}
