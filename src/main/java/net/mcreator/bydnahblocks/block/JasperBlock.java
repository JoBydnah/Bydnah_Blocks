...
public class JasperBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:jasper")
	public static final Block block = null;

	public JasperBlock(BydnahBlocksModElements instance) {
		super(instance, 603);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("bydnah_blocks:jasper_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("jasper"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("bydnah_blocks:jasper"), configuredFeature);
		}
	}
