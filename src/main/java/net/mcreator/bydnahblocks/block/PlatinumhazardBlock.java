...
public class PlatinumhazardBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:platinumhazard")
	public static final Block block = null;

	public PlatinumhazardBlock(BydnahBlocksModElements instance) {
		super(instance, 222);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("platinumhazard");
		}
