...
public class HazardBlackBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:hazard_black")
	public static final Block block = null;

	public HazardBlackBlock(BydnahBlocksModElements instance) {
		super(instance, 31);
	}
