...
public class SlatetilesmediumBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:slatetilesmedium")
	public static final Block block = null;

	public SlatetilesmediumBlock(BydnahBlocksModElements instance) {
		super(instance, 596);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slatetilesmedium");
		}
