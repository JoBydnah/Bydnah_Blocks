...
public class MetalplatingwhiteBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:metalplatingwhite")
	public static final Block block = null;

	public MetalplatingwhiteBlock(BydnahBlocksModElements instance) {
		super(instance, 255);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metalplatingwhite");
		}
