...
public class AridsandstonesmallbricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:aridsandstonesmallbricks")
	public static final Block block = null;

	public AridsandstonesmallbricksBlock(BydnahBlocksModElements instance) {
		super(instance, 562);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aridsandstonesmallbricks");
		}
