...
public class DioriteornateBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioriteornate")
	public static final Block block = null;

	public DioriteornateBlock(BydnahBlocksModElements instance) {
		super(instance, 476);
	}
