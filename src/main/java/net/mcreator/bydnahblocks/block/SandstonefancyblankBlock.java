...
public class SandstonefancyblankBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstonefancyblank")
	public static final Block block = null;

	public SandstonefancyblankBlock(BydnahBlocksModElements instance) {
		super(instance, 494);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstonefancyblank");
		}
