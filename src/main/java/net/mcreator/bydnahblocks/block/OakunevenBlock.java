...
public class OakunevenBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:oakuneven")
	public static final Block block = null;

	public OakunevenBlock(BydnahBlocksModElements instance) {
		super(instance, 282);
	}
