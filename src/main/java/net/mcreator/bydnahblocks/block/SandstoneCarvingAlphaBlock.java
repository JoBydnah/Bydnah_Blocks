...
public class SandstoneCarvingAlphaBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:sandstone_carving_alpha")
	public static final Block block = null;

	public SandstoneCarvingAlphaBlock(BydnahBlocksModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstone_carving_alpha");
		}
