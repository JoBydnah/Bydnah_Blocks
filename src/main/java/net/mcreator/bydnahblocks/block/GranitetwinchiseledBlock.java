...
public class GranitetwinchiseledBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:granitetwinchiseled")
	public static final Block block = null;

	public GranitetwinchiseledBlock(BydnahBlocksModElements instance) {
		super(instance, 472);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitetwinchiseled");
		}
