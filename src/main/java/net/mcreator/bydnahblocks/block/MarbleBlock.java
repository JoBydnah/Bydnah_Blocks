...
public class MarbleBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:marble")
	public static final Block block = null;

	public MarbleBlock(BydnahBlocksModElements instance) {
		super(instance, 307);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("bydnah_blocks:marble_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("marble"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("bydnah_blocks:marble"), configuredFeature);
		}
	}
