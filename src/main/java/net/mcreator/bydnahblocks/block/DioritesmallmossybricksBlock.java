...
public class DioritesmallmossybricksBlock extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:dioritesmallmossybricks")
	public static final Block block = null;

	public DioritesmallmossybricksBlock(BydnahBlocksModElements instance) {
		super(instance, 431);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dioritesmallmossybricks");
		}
