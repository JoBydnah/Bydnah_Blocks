...
public class OrichalcumAxeItem extends BydnahBlocksModElements.ModElement {
	@ObjectHolder("bydnah_blocks:orichalcum_axe")
	public static final Item block = null;

	public OrichalcumAxeItem(BydnahBlocksModElements instance) {
		super(instance, 690);
	}
