 ...
 *
 *    Keep the BydnahBlocksModElements object in this class and all calls to this object
...
public class BydnahBlocksMod {
	...
	public BydnahBlocksMod() {
		elements = new BydnahBlocksModElements();
		FMLJavaModLoadingContext.get().getModEventBus().register(this);
		FMLJavaModLoadingContext.get().getModEventBus().addListener(this::init);
		FMLJavaModLoadingContext.get().getModEventBus().addListener(this::clientLoad);
		MinecraftForge.EVENT_BUS.register(new BydnahBlocksModFMLBusEvents(this));
	}
	...
	private static class BydnahBlocksModFMLBusEvents {
		private final BydnahBlocksMod parent;

		BydnahBlocksModFMLBusEvents(BydnahBlocksMod parent) {
			this.parent = parent;
		}
