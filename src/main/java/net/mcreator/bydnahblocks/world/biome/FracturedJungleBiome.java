...
public class FracturedJungleBiome extends BydnahBlocksModElements.ModElement {
	public static Biome biome;

	public FracturedJungleBiome(BydnahBlocksModElements instance) {
		super(instance, 733);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-10027111).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-6684775).withGrassColor(-10027162).build();
				...
				event.getRegistry().register(biome.setRegistryName("bydnah_blocks:fractured_jungle"));
			}
		}
	}
